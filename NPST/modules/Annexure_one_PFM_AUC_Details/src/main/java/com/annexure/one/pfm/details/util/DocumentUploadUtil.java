...
public class DocumentUploadUtil {
	...
	public static long getFileentryId(ResourceRequest resourceRequest, long GroupId, File file, String file_name, String mimeType, String title, String description) {
