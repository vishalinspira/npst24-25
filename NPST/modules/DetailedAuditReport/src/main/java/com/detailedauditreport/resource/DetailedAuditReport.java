package com.detailedauditreport.resource;
...
@Component(property = { 
		...
		"mvc.command.name=" + DetailedAuditReportPortletKeys.DetailedAuditReport,
		}, 
service = MVCResourceCommand.class)

public class DetailedAuditReport implements MVCResourceCommand {

	private static Log _log = LogFactoryUtil.getLog(DetailedAuditReport.class.getName());
...
_log.info("Serve Resource method");
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		/*
		 * String fileName =
		 * uploadPortletRequest.getFileName("detailedAuditReportPDFFile");
		 * 
		 * _log.info("fileName::::::::::::::::::::::"+fileName);
		 * 
		 * File file = uploadPortletRequest.getFile("detailedAuditReportPDFFile");
		 * 
		 * String mimeType =
		 * uploadPortletRequest.getContentType("detailedAuditReportPDFFile");
		 * 
		 * String title = fileName;
		 */
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
	
		Long fileEntryId1=uploadFILETOFOLDER(themeDisplay, resourceRequest,"detailedAuditReportDocFile");
			Long fileEntryId = 0l;
			fileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest,"detailedAuditReportPDFFile");
