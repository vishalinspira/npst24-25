		...
		<portlet:resourceURL id="/annextena/save" var="saveannextenaURL"></portlet:resourceURL>
                    ...
                    <input type="hidden" name="reportUploadLogId" class="reportUploadLogId"/>
                    	<fieldset class="row mb-3">
		                  ...
		                  <div class="col-sm-12">
		                    <div class="form-check form-check-inline">
		                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="11" >
		                      <label class="form-check-label ml-1" for="gridRadios1">
		                        PCRA
		                      </label>
		                    </div>
		                    <div class="form-check form-check-inline">
		                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="23">
		                      <label class="form-check-label ml-1" for="gridRadios2">
		                        KCRA
		                      </label>
		                    </div>
		                    <div class="form-check form-check-inline">
		                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios3" value="128">
                        ...
                        <div class="nps-input-box file-upload">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile" name="annextenaFile" />                               
                            </div>
                            <label id="error-annextenaFile" class="error-message text-danger"></label>
                        </div>
 	...
 	<div class="row">
				...
				<div class="row">
				    <div class="col">
				        <div class="page_title">
				            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Withdrawal MIS
				        </div>
				    </div>
				</div>
						    ...
						    <div class="col">
								<aui:form id="fileinfo" method="POST" >
									...
									<fieldset class="row mb-3">
					                  ...
					                  <div class="col-sm-12">
					                    <div class="form-check form-check-inline">
					                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="11" >
					                      <label class="form-check-label ml-1" for="gridRadios1">
					                        NSDL
					                      </label>
					                    </div>
					                    <div class="form-check form-check-inline">
					                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="23">
					                      <label class="form-check-label ml-1" for="gridRadios2">
					                        Kfintech
					                      </label>
					                    </div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="fileUploadInput">
													<input type="file" class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="annextenaFile" />
													<button type="button" class="btn file-btn">Choose File</button>
												</div>
												<label id="error-annextenaFile" class="error-message"></label>
											</div>
										</div>
									</div>
		...
		$(function(){
		    ...
		    $('#upload').on('click', function(){
		    	if ($('input[name="annextenaFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-annextenaFile").html("Please select a file to upload");
		    	    return false;
		    	} else if($('input[name="annextenaFile"]').get(0).files[0].name != "Withdrawal MIS.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-annextenaFile").html("Please upload Withdrawal MIS.xlsx");
		    	    return false;
		    	}
