package com.Griev.handled.Nps.Trust.resource;

import com.Griev.handled.Nps.Trust.constants.Griev_handledNpsTrustPortletKeys;
...
@Component(
		immediate = true,
		property = {
				"javax.portlet.name=" + Griev_handledNpsTrustPortletKeys.GRIEV_HANDLEDNPSTRUST,
				"mvc.command.name=/savepmar/data",
		},
		service = MVCResourceCommand.class
		)

public class SaveGriev_handledNpsTrust implements MVCResourceCommand{
		@Override
