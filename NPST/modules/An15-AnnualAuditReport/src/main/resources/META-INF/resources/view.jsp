<%@page import="An15.AnnualAuditReport.constants.An15AnnualAuditReportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=An15AnnualAuditReportPortletKeys.auditReport%>" var="PDFURLAnnexure" />
<portlet:resourceURL id="<%=An15AnnualAuditReportPortletKeys.getReportUpload%>" var="GetReportURL" />  
<!-- Modal -->
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Annual Audit Report
	        </div>
	    </div>
	</div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexFifteenFile"]').get(0).files.length === 0) {
    	    ...
    	    return false;
    	}else if($('input[name="annexFifteenFile"]').get(0).files[0].name != "Annual Audit Report-converted.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexFifteenFile").html("Please upload Annual Audit Report-converted.pdf");
    	    return false;
    	}
