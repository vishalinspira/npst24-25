package com.annex15.annualauditreport.resource;
...
import An15.AnnualAuditReport.constants.An15AnnualAuditReportPortletKeys;

@Component(property = { 
		"javax.portlet.name=" + An15AnnualAuditReportPortletKeys.AN15ANNUALAUDITREPORT,
		"mvc.command.name=" + An15AnnualAuditReportPortletKeys.auditReport, 
		}, 
service = MVCResourceCommand.class)

public class AnnualAuditReport implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(AnnualAuditReport.class);
