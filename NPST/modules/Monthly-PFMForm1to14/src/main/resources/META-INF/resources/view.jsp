<%@page import="Monthly.PFMForm1to14.constants.MonthlyPFMForm1to14PortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=MonthlyPFMForm1to14PortletKeys.pfm%>" var="pfmResourceURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="sbiFile" />
                           </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="sbiFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-sbiFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="sbiFile"]').get(0).files[0].name != "Monthly Form 1-9.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-sbiFile").html("Please upload Monthly Form 1-9.xlsx");
	    	    return false;
	    	}
