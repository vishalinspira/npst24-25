<%@page import="com.tds.report.pfm.constants.TDSReportFromPFMPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=TDSReportFromPFMPortletKeys.tdsReport%>" var="tdsResourceURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="tdsFile" />
                           </div>
                           <label id="error-tdsFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="tdsFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-tdsFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="tdsFile"]').get(0).files[0].name != "TDS report - PFM.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-tdsFile").html("Please upload TDS report - PFM.xlsx");
	    	    return false;
	    	}
