<%@page import="com.assetnotundercustodyreport.constants.AssetNotUnderCustodyReportPortletKeys"%>
<%@ include file="/init.jsp" %>
<portlet:resourceURL id="<%=AssetNotUnderCustodyReportPortletKeys.assetNotUnderCustody%>" var="assetNotUnderCustodyReportResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Asset not under custody report</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile_1" name="assetNotUnderCustodyReportPDFFile" accept=".pdf"/>
                     </div>
                     <label id="error-assetNotUnderCustodyReportPDFFile" class="error-message text-danger"></label>
                  </div>
                  <div class="nps-input-box file-upload">
                     <label>Report </label>
                     <div class="file-select">
                        ...
                        <div class="file-select-button common-btn" id="fileName">Choose File</div>
                        <input type="file" id="chooseFile_2" name="assetNotUnderCustodyReportXlssFile" accept=".xlsx"/>
                     </div>
                     <label id="error-assetNotUnderCustodyReportXlssFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="assetNotUnderCustodyReportPDFFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-assetNotUnderCustodyReportPDFFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="assetNotUnderCustodyReportPDFFile"]').get(0).files[0].name != "Asset Not under Custody Report.pdf"){
    		console.log("No files selected.");
    	    $("#error-assetNotUnderCustodyReportPDFFile").html("Please upload Asset Not under Custody Report.pdf");
    	    return false;
    	}
    	
    	if ($('input[name="assetNotUnderCustodyReportXlssFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-assetNotUnderCustodyReportXlssFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="assetNotUnderCustodyReportXlssFile"]').get(0).files[0].name != "Asset Not under Custody Report.xlsx"){
    		console.log("No files selected.");
    	    $("#error-assetNotUnderCustodyReportXlssFile").html("Please upload Asset Not under Custody Report.xlsx");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-assetNotUnderCustodyReportPDFFile").html("");
        $("#error-assetNotUnderCustodyReportXlssFile").html("");
        $.ajax({
            url: '${assetNotUnderCustodyReportResourceURL}', 
            type: 'POST',
            data: fd,
