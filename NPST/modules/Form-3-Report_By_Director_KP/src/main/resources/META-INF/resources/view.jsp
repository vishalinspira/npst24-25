<%@page import="com.report.director.kp.constants.Form3Report_By_Director_KPPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Form3Report_By_Director_KPPortletKeys.formThreeReport%>" var="formThreeReportResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>FORM-3 REPORT By Director And Key Personal On Instances Of Self Dealing</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="Form3Report" />
                     </div>
                     <label id="error-Form3Report" class="error-message text-danger"></label>
                  </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="Form3Report"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-Form3Report").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="Form3Report"]').get(0).files[0].name != "Form 3 Report by Director and KP1.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-Form3Report").html("Please upload Form 3 Report by Director and KP1.xlsx");
	    	    return false;
	    	}
	        ...
	        $.ajax({
	            ...
	            contentType: false,
	            cache: false,
	            url: '${formThreeReportResourceURL}',
	            data: formData,
