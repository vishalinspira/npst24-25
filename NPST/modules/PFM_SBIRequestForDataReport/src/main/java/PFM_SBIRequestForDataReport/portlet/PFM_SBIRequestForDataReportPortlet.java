package PFM_SBIRequestForDataReport.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=PFM_SBIRequestForDataReport",
...
public class PFM_SBIRequestForDataReportPortlet extends MVCPortlet {
}