...
@Component(
		...
		property = {
			...
			"javax.portlet.display-name=QuarterlyStewardshipReportScrutiny",
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/scrutinyview.jsp",
			"javax.portlet.name=" + QuarterlyStewardshipReportPortletKeys.QUARTERLYSTEWARDSHIPREPORTSCRUTINY,
...
public class QuarterlyStewardshipReportScrutinyPortlet extends MVCPortlet {
	
	private static Log _log = LogFactoryUtil.getLog(QuarterlyStewardshipReportScrutinyPortlet.class);
