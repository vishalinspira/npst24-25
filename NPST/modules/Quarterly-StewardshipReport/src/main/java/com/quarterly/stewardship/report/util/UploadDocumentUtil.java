...
public class UploadDocumentUtil {
	public static long uploadFile(File file,ThemeDisplay themeDisplay,ResourceRequest resourceRequest){
		...
		String fileName = date.getTime()+"_"+"stewardship_report_pdf_file"+".pdf";
...
public static long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest, String param, String pdfORNot) {
		...
		if(pdfORNot.equalsIgnoreCase("pdf")) {
			...
			fileName = date.getTime()+"_"+"stewardship_report_pdf_file"+".pdf";
			
			title = fileName;
			
			description = "Quarterly Stewardship Report PDF";
		}
