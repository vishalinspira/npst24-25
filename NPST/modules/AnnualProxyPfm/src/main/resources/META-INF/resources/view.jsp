...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<portlet:resourceURL id="/annualproxypfm/save" var="saveannualproxypfmURL"></portlet:resourceURL>
	  ...
	  <div class="row">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Annual report on proxy voting</h4>
                    <div class="content">
						...
						<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
	                        ...
	                        <div class="nps-input-box file-upload">
	                            ...
	                            <div class="file-select">
	                               ...
	                               <input type="file" class="chooseFile" id="chooseFile" name="annualproxypfmFile" />                               
	                            </div>
	                            <label id="error-annualproxypfmFile" class="error-message text-danger"></label>
	                        </div>
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="annualproxypfmFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-annualproxypfmFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="annualproxypfmFile"]').get(0).files[0].name != "Annual report on proxy voting.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-annualproxypfmFile").html("Please upload Annual report on proxy voting.xlsx");
		    	    return false;
		    	}
		        ...
		        $(".content").hide();
		        $(".animaion").show();
		        $("#error-annualproxypfmFile").html("");
		        $.ajax({
		            url: '<%=saveannualproxypfmURL %>',  
		            type: 'POST',
		            data: fd,
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="annualproxypfmFile"').val("");
