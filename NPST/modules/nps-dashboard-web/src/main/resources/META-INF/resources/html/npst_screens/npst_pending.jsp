...
<portlet:resourceURL id="<%=NPSDashboardWebPortletKeys.CHECK_REPORTS_MVC_RESOURCE_COMMAND%>" var="checkReportsMVCResourceCommandURL">
	<portlet:param name="action" value="<%=NPSDashboardWebPortletKeys.PENDING_FOR_UPLOAD%>"/>
</portlet:resourceURL>
<div class="card_blocks">
	<div class="row">
		<div class="col">
			<div class="page_title">
				<img src="<%=request.getContextPath()%>/images/report.png" alt="Reports" /> Pending for Upload
			</div>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$.ajax({
		...
		success: function(jsonObject) {
			console.log("jsonArray : ",jsonObject);
