...
List<ReportStatusLog> reports=fcr.getReports(NPSCompany.NPST, "MAKERS_REPORT_SUMMARY",themeDisplay);
            ...
            <div class="tab-content">
                <div class="tab-pane active py-3" id="report-status">
                	<table id="report_status_table" cellspacing="0" width="100%" class="display dataTable no-footer dtr-inline">
						...
						FileEntry entry= DLAppLocalServiceUtil.getFileEntry(reportStatusLog.getFileEntryId());
						%>
						<tr>
	
							<td class="tbdata"><a href='<%=Validator.isNotNull(entry)?DLURLHelperUtil.getDownloadURL(entry, entry.getFileVersion(), themeDisplay, ""): reportStatusLog.getFileUrl()%>'><%=reportStatusLog.getReportName() %></a></td>
