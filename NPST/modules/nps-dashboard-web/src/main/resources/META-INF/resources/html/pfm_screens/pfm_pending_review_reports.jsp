   ...
   <div class="nps-pending-table">
       <div class="mydataTable">
            <ul class="nav nav-tabs border-0 mb-3 nps-report-main">
                ...
                <%} %>
                <li class="nav-item">
                    <a data-bs-toggle="tab" class='nav-link <%=isWeeklyVisible ? "":"active" %> p-0' href="#pills-monthly"> Monthly</a>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade py-3" id="pills-halfyearly">
                	<table id="pending_reports_table_halfyearly" cellspacing="0" width="100%" class="display dataTable no-footer dtr-inline"></table>
                </div>
...
<%if(false) {%>
	...
	<%@ include file="/html/report_master_table.jsp"%>
...
function createReportsTable2() {
    ...
    tabsArray.push({"tabid":"pending_reports_table_halfyearly", "dataKey":"Half-Yearly"});
			...
			tabsArray.forEach(function(v, i){
				...
				var table = $('#' + v.tabid).DataTable({
					...
					initComplete: function () {
						if(<%= isWeeklyVisible%> && v.dataKey != 'Weekly'){
