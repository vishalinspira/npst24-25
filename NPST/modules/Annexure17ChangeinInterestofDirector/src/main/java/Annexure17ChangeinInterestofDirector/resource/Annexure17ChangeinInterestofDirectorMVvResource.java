package Annexure17ChangeinInterestofDirector.resource;
...
import Annexure17ChangeinInterestofDirector.constants.Annexure17ChangeinInterestofDirectorPortletKeys;

@Component(property = { 
		"javax.portlet.name=" + Annexure17ChangeinInterestofDirectorPortletKeys.ANNEXURE17CHANGEININTERESTOFDIRECTOR,
		"mvc.command.name=" + Annexure17ChangeinInterestofDirectorPortletKeys.SaveAnnexurexviiPDF,
		}, 
service = MVCResourceCommand.class)

public class Annexure17ChangeinInterestofDirectorMVvResource implements MVCResourceCommand {
 ...
 public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
     _log.info("fileUpload:::::::::::::::::::::::::::");
		...
		String fileName = uploadPortletRequest.getFileName("annexurexviifile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("annexurexviifile");

		String mimeType = uploadPortletRequest.getContentType("annexurexviifile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("annexurexviifile");
		...
		String description = "annexurexviifile";
