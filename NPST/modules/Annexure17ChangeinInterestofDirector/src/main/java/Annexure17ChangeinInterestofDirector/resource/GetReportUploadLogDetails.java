...
@Component(property = { "javax.portlet.name=" + Annexure17ChangeinInterestofDirectorPortletKeys.ANNEXURE17CHANGEININTERESTOFDIRECTOR,
"mvc.command.name="+ Annexure17ChangeinInterestofDirectorPortletKeys.GetReportAnnexureXVII,}, service = MVCResourceCommand.class)
