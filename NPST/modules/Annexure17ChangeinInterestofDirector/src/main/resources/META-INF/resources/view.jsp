<%@page import="Annexure17ChangeinInterestofDirector.constants.Annexure17ChangeinInterestofDirectorPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Annexure17ChangeinInterestofDirectorPortletKeys.SaveAnnexurexviiPDF%>" var="SaveAnnexurexviiPDFURL" />
<portlet:resourceURL id="<%=Annexure17ChangeinInterestofDirectorPortletKeys.GetReportAnnexureXVII%>" var="GetReportAnnexureXVIIURL" />  
<!-- Modal -->
        ...
        <div class="row">
	     <div class="col-12">
	        <div class="text-right">
	            <p  class="back_btn"><a class="backbtn" href="/web/guest/half-yearly-average"><i class="fas fa-arrow-left text-white pr-3"></i>Back</a></p>
	        </div>
	     </div>
	  </div>
   <div class="row">
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="AnnexurexviiFile" />
                           </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Interest of Directors
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="AnnexurexviiFile" />
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="AnnexurexviiFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-annexurexiiiFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="AnnexurexviiFile"]').get(0).files[0].name != "Interest of Directors.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexurexiiiFile").html("Please upload Interest of Directors.pdf");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="AnnexurexviiFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
