...
<portlet:resourceURL id="/annexii_am/save" var="Uplaodannexii_amURL" /> 
<portlet:resourceURL id="/annexii_am/getreportlogdetails" var="getreportlogdetailsURL"/>
        ...
        <div class="row">
	     <div class="col-12">
	        <div class="text-right">
	            <p  class="back_btn"><a class="backbtn" href="/web/guest/annually-am-report"><i class="fas fa-arrow-left text-white pr-3"></i>Back</a></p>
	        </div>
	     </div>
	  </div>
    <div class="row">
        <div class="col-lg-7 col-md-10 col-sm-12 col-12">
            <div class="nps-report">
                <h4>Annexure 12 Statutory Auditor Certificate</h4>
                <div class="content">
                ...
                <input type="hidden" value="37" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
                <div class="nps-input-box mt-0">
                   ...
                   <div class="nps-input-box file-upload">
                       ...
                       <div class="file-select">
                          ...
                          <input type="file" class="chooseFile" id="chooseFile" name="annexii_amFile" />                               
                       </div>
                       <label id="error-annexii_amFile" class="error-message text-danger"></label>
                   </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Annexure 12 Statutory Auditor Certificate
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="annexii_amFile" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-annexii_amFile" class="error-message"></label>
							</div>
						</div>
					</div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexii_amFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-annexii_amFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="annexii_amFile"]').get(0).files[0].name != "Annexure 12 Statutory Auditor Certificate.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexii_amFile").html("Please upload Annexure 12 Statutory Auditor Certificate.pdf");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-annexii_amFile").html("");
        $.ajax({
            url: '${Uplaodannexii_amURL}', 
            type: 'POST',
            data: fd,
            success:function(data){
            	$(".content").show();
