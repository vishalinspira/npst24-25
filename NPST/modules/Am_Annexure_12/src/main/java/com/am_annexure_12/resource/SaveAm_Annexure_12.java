package com.am_annexure_12.resource;
...
@Component(property = { "javax.portlet.name=" + Am_Annexure_12PortletKeys.AM_ANNEXURE_12,
"mvc.command.name=/annexii_am/save" }, service = MVCResourceCommand.class)

public class SaveAm_Annexure_12 implements MVCResourceCommand {
	@Override
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("annexii_amFile");
		
		_log.info("fileName:::::::::::::::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("annexii_amFile");

		String mimeType = uploadPortletRequest.getContentType("annexii_amFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("annexii_amFile");
		...
		String description = "annexii_amFile";
