...
import com.daily.average.service.service.QrFinalVoteCountLocalServiceUtil;
...
public class form1 {
	...
	public static JSONObject saveForm1(File file, XSSFWorkbook workbook, long userId, JSONArray errorArray, XSSFSheet xx, 
			boolean isexcelhaserror, JSONArray form1JsonArray, List<QrFinalVoteCount> form1List, DecimalFormat decimalFormat, List<String> errorlist, Long reportUploadLogId) {
		_log.info("Inside saveForm1");
		
		QrFinalVoteCountLocalServiceUtil.deleteQrFinalVoteCountByReportUploadLogId(reportUploadLogId);
		//String sheetName="Final Vote Count";
		String sheetName="Final Majority Vote Count";
			...
			if (file != null) {
				...
				if(null != sheet) {
					...
					while (rows.hasNext()) {
						...
						QrFinalVoteCount form1 = QrFinalVoteCountLocalServiceUtil.createQrFinalVoteCount(CounterLocalServiceUtil.increment(QrFinalVoteCount.class.getName()));
					...
					errorlist.add("Final Majority Vote Count");
				}
