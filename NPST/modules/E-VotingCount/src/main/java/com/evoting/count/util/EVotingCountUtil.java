...
@Component(immediate = true, property = {}, service = EVotingCountUtil.class)
public class EVotingCountUtil {
	
	public List<Integer> getRowsFromFinalVoteCount(int to) {
		List<Integer> rowList = new ArrayList<>();
		rowList = extendList(rowList, 2, to);
		return rowList;
	}
	
	public List<Integer> getRowsFromPFVotingRecommCount(int to) {
		List<Integer> rowList = new ArrayList<>();
		rowList = extendList(rowList, 2, to);
		return rowList;
	}
