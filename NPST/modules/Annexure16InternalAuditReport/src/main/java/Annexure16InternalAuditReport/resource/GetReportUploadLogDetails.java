...
@Component(property = { "javax.portlet.name=" + Annexure16InternalAuditReportPortletKeys.ANNEXURE16INTERNALAUDITREPORT,
"mvc.command.name="+ Annexure16InternalAuditReportPortletKeys.GETAnnexure16,}, service = MVCResourceCommand.class)
