<%@page import="Annexure16InternalAuditReport.constants.Annexure16InternalAuditReportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Annexure16InternalAuditReportPortletKeys.ANNEXURE16INTERNAL%>" var="PDFURL" />
<portlet:resourceURL id="<%=Annexure16InternalAuditReportPortletKeys.GETAnnexure16%>" var="GetReportURL" />  
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="annexurexVIFile" />
                           </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Internal Audit Report
	        </div>
	    </div>
	</div>
				...
				<aui:form id="fileinfo" method="POST" >
				 ...
				 <div class="row">
                	...
                	<div class="col-md-6">
                		<div class="form-group">
                			<label>Remarks</label>
                			<textarea id="remarks" class="form-control" rows="" cols="" name="remarks"></textarea>
                		</div>
                	</div>
			       </div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="annexurexVIFile" />
...
function getreportUploadLogId(){
	console.log("Get report upload log Id ... ");
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexurexVIFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-annexurexiiiFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="annexurexVIFile"]').get(0).files[0].name != "Annexure 16 Internal Audit Report.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexurexiiiFile").html("Please upload Annexure 16 Internal Audit Report.pdf");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="annexurexVIFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
