package com.annual.proxyvotingreports.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=AnnualProxyVotingReports",
...
public class AnnualProxyVotingReportsPortlet extends MVCPortlet {
}