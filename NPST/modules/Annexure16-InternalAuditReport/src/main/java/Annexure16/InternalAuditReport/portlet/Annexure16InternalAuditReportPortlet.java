package Annexure16.InternalAuditReport.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Annexure16InternalAuditReport",
...
public class Annexure16InternalAuditReportPortlet extends MVCPortlet {
}