...
<portlet:resourceURL id="/majorityvotes/save" var="savemajorityvotesURL"></portlet:resourceURL>
	                ...
	                <div class="nps-input-box mt-0">
                       ...
                       <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" class="chooseFile" id="chooseFile" name="majorityvotesFile" />                               
                           </div>
                           <label id="error-majorityvotesFile" class="error-message text-danger"></label>
                       </div>
...
$(function(){
    $('#upload').on('click', function(){
    	if ($('input[name="majorityvotesFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-majorityvotesFile").html("Please select a file to upload");
    	    return false;
    	} else if($('input[name="majorityvotesFile"]').get(0).files[0].name != "Majority Votes.xlsx"){
    		console.log("No files selected.");
    	    $("#error-majorityvotesFile").html("Please upload Majority Votes.xlsx");
    	    return false;
    	}
        ...
        $(".nps-report").hide();
        $(".animaion").show();
        $("#error-majorityvotesFile").html("");
        $.ajax({
            url: '<%=savemajorityvotesURL %>',  
            type: 'POST',
            data: fd,
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="majorityvotesFile"').val("");
