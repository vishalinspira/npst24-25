         ...
         <div class="nps-report">
            <div class="form_block">
               <div class=" content">
                  ...
                  <h4>PF Voting Recommendation</h4>
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="pfVotingFile" />
                           </div>
                           <label id="error-pfVotingFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="pfVotingFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-pfVotingFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="pfVotingFile"]').get(0).files[0].name != "PF Voting Recommendation.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-pfVotingFile").html("Please upload PF Voting Recommendation.xlsx");
	    	    return false;
	    	}
