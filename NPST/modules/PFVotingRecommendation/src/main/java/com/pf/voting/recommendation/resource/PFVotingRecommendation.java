package com.pf.voting.recommendation.resource;
...
import com.pf.voting.recommendation.constants.PFVotingRecommendationPortletKeys;
...
@Component(
		immediate = true,
		property = { 
				"javax.portlet.name=" + PFVotingRecommendationPortletKeys.PFVOTINGRECOMMENDATION,
				"mvc.command.name=" + PFVotingRecommendationPortletKeys.pfVoting,
		}, 
		service = MVCResourceCommand.class
	)
public class PFVotingRecommendation implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(PFVotingRecommendation.class.getName());
