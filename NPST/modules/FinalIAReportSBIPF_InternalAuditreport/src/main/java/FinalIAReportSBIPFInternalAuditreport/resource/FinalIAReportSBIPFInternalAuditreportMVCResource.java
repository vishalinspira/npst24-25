package FinalIAReportSBIPFInternalAuditreport.resource;
...
@Component(property = { 
		...
		"mvc.command.name=" + FinalIAReportSBIPFInternalAuditreportPortletKeys.finalIAR,
		}, 
service = MVCResourceCommand.class)


public class FinalIAReportSBIPFInternalAuditreportMVCResource implements MVCResourceCommand{
	
	private static Log _log = LogFactoryUtil.getLog(FinalIAReportSBIPFInternalAuditreportMVCResource.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("internalAuditReportFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("internalAuditReportFile");

		String mimeType = uploadPortletRequest.getContentType("internalAuditReportFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("internalAuditReportFile");
		...
		String description = "internalAuditReportFile";
