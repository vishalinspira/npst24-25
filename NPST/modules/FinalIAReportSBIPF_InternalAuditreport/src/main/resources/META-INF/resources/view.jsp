<%@page import="FinalIAReportSBIPFInternalAuditreport.constants.FinalIAReportSBIPFInternalAuditreportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=FinalIAReportSBIPFInternalAuditreportPortletKeys.finalIAR%>" var="pdfInternalAuditReportURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Final IA Report SBIPF Internal Audit Report for the quarter</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="internalAuditReportFile" />
                     </div>
                     <label id="error-internalAuditReportFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="internalAuditReportFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-internalAuditReportFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="internalAuditReportFile"]').get(0).files[0].name != "Internal Audit report - PFM.pdf"){
    		console.log("No files selected.");
    	    $("#error-internalAuditReportFile").html("Please upload Internal Audit report - PFM.pdf");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-internalAuditReportFile").html("");
        $.ajax({
            url: '${pdfInternalAuditReportURL}', 
            type: 'POST',
            data: fd,
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="internalAuditReportFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
