package com.annex18.biodata.resource;
...
import An18.Biodata.constants.An18BiodataPortletKeys;

@Component(property = { 
		"javax.portlet.name=" + An18BiodataPortletKeys.AN18BIODATA,
		"mvc.command.name=" + An18BiodataPortletKeys.biodata, 
		}, 
service = MVCResourceCommand.class)

public class BioData implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(BioData.class);
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
       _log.info("fileUpload:::::::::::::::::::::::::::");
		...
		String fileName = uploadPortletRequest.getFileName("annexEighteenFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("annexEighteenFile");

		String mimeType = uploadPortletRequest.getContentType("annexEighteenFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("annexEighteenFile");
		...
		String description = "annexEighteenFile";
	...
	public Folder getFolder(ThemeDisplay themeDisplay) {
		...
		Folder folder = null;
		try {
			folder = DLAppServiceUtil.getFolder(themeDisplay.getScopeGroupId(), PARENT_FOLDER_ID, "Periodically");
			_log.info(folder);
