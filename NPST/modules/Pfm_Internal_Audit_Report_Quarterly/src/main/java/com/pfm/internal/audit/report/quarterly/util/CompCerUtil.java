...
public class CompCerUtil {
	
	public static long uploadFile(File file,ThemeDisplay themeDisplay,ResourceRequest resourceRequest){
		Date date=new Date();
	
		String fileName = date.getTime()+"_"+"quarterly_internal_audit_report"+".pdf";
		String title = fileName; 
		String description = "Quarterly Interal Audit Report PDF";
...
public static long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest, String param, String pdfORNot) {
		...
		String description = "pfm_internalaudit";
		
		if(pdfORNot.equalsIgnoreCase("pdf")) {
			fileName = StringPool.BLANK; title = StringPool.BLANK; description = StringPool.BLANK;
			
			fileName = date.getTime()+"_"+"pfm_internalaudit"+".pdf";
			
			title = fileName;
			
			description = "pfm_internalaudit PDF";
		}
	...
	static	Log _log =LogFactoryUtil.getLog(CompCerUtil.class);
