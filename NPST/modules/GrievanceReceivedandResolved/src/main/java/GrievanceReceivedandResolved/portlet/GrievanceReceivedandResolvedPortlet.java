package GrievanceReceivedandResolved.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=GrievanceReceivedandResolved",
...
public class GrievanceReceivedandResolvedPortlet extends MVCPortlet {
}