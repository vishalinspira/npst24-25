<%@page import="AnnexureI_AUC_Details.constants.AnnexureI_AUC_DetailsPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=AnnexureI_AUC_DetailsPortletKeys.pfm%>" var="pfmResourceURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="annexureFile" />
                           </div>
                           <label id="error-annexureFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="annexureFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-annexureFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="annexureFile"]').get(0).files[0].name != "Annexure I - AUC Details.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-annexureFile").html("Please upload Annexure I - AUC Details.xlsx");
	    	    return false;
	    	}
