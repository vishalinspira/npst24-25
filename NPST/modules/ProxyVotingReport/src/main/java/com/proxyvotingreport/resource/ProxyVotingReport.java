package com.proxyvotingreport.resource;
...
@Component(property = { 
		...
		"mvc.command.name=" + ProxyVotingReportPortletKeys.proxyVotingDocumentUpload,
		}, 
service = MVCResourceCommand.class)


public class ProxyVotingReport implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(ProxyVotingReport.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
			...
			pdfFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "proxyVotePDFFile");
			Long excelFileEntryId = 0l;
			excelFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "proxyVoteExcelFile");
			
			JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
			jsonArray.put(pdfFileEntryId);
			jsonArray.put(excelFileEntryId);
