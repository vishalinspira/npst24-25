<%@page import="MonthlyReportFormat.constants.MonthlyReportFormatPortletKeys"%>
<%@ include file="/init.jsp" %>

<!-- <portlet:resourceURL id="/annexureiva/save" var="annexureivaURL"></portlet:resourceURL> -->
<portlet:resourceURL id="<%=MonthlyReportFormatPortletKeys.SaveMonthlyReportFormat%>" var="saveMonthlyreportURL" /> 
<!-- 1. -->
<!-- Modal -->
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="monthlyreport" />
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="monthlyreport"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-votingreport").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="monthlyreport"]').get(0).files[0].name !="Monthly Report Format.xlsx"){
	    		console.log("No files selected.");
