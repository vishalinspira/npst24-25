<%@page import="SES.VoteMatrix.portlet.CheckRoleUtil"%>
<%@page import="SES.VoteMatrix.constants.SESVoteMatrixPortletKeys"%>
...
<portlet:resourceURL id="<%=SESVoteMatrixPortletKeys.vote%>" var="voteMatrixResourceURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="voteFile" />
                           </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Vote Matrix
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="voteFile" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-voteFile" class="error-message"></label>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
	  ...
	  var who = themeDisplay.getUserEmailAddress;
	  console.log("hey-----------------",who);
	});
