		...
		<portlet:resourceURL id="/annexureten/save" var="saveannexuretenURL"></portlet:resourceURL>
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Summarized data of Performance Report</h4>
                    	<div class="content">
										...
										<fieldset class="row mb-3">
						                  ...
						                  <div class="col-sm-12">
						                    <div class="form-check form-check-inline">
						                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="10" >
						                      <label class="form-check-label ml-1" for="gridRadios1">
						                        PCRA
						                      </label>
						                    </div>
						                    <div class="form-check form-check-inline">
						                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="22">
						                      <label class="form-check-label ml-1" for="gridRadios2">
						                        KCRA
						                      </label>
						                    </div>
						                    <div class="form-check form-check-inline">
						                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios3" value="127">
	                        ...
	                        <div class="nps-input-box file-upload">
	                            ...
	                            <div class="file-select">
	                               ...
	                               <input type="file" class="chooseFile" id="chooseFile" name="annexuretenFile" />                               
	                            </div>
	                            <label id="error-annexuretenFile" class="error-message text-danger"></label>
	                        </div>
 	...
 	<div class="row">
				...
				<div class="row">
				    <div class="col">
				        <div class="page_title">
				            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Summarized data of Performance Report
				        </div>
				    </div>
				</div>
						    ...
						    <div class="col">
								<aui:form id="fileinfo" method="POST" >
									...
									<fieldset class="row mb-3">
					                  ...
					                  <div class="col-sm-12">
					                    <div class="form-check form-check-inline">
					                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="10" >
					                      <label class="form-check-label ml-1" for="gridRadios1">
					                        NSDL
					                      </label>
					                    </div>
					                    <div class="form-check form-check-inline">
					                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="22">
					                      <label class="form-check-label ml-1" for="gridRadios2">
					                        Kfintech
					                      </label>
					                    </div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="fileUploadInput">
													<input type="file" class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="annexuretenFile" />
													<button type="button" class="btn file-btn">Choose File</button>
												</div>
												<label id="error-annexuretenFile" class="error-message"></label>
											</div>
										</div>
									</div>
		...
		$(function(){
		    ...
		    $('#upload').on('click', function(){
		    	if ($('input[name="annexuretenFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-annexuretenFile").html("Please select a file to upload");
		    	    return false;
		    	} else if($('input[name="annexuretenFile"]').get(0).files[0].name != "Summarized data of Performance Report.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-annexuretenFile").html("Please upload Summarized data of Performance Report.xlsx");
		    	    return false;
		    	}
		            ...
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="annexuretenFile"').val("");
		           		 	$('#remarks').val("");
