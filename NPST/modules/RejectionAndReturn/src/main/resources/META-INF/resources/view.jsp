...
<portlet:resourceURL id="/rejectionreturn/save" var="saverejectionReturnURL"></portlet:resourceURL>
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Rejection & Return MIS (Electronic)</h4>
                    <div class="content">
	                    <aui:form id="fileinfo" method="POST" >
								...
								<fieldset class="row mb-3">
				                  ...
				                  <div class="col-sm-12">
				                    <div class="form-check form-check-inline">
				                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="3" >
				                      <label class="form-check-label ml-1" for="gridRadios1">
				                        PCRA
				                      </label>
				                    </div>
				                    <div class="form-check form-check-inline">
				                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="17">
				                      <label class="form-check-label ml-1" for="gridRadios2">
				                        KCRA
				                      </label>
				                    </div>
				                    <div class="form-check disabled form-check-inline">
				                      <input class="reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios3" value="18" >
	                        ...
	                        <div class="nps-input-box file-upload">
	                            ...
	                            <div class="file-select">
	                               ...
	                               <input type="file" class="chooseFile" id="chooseFile" name="rejectionReturnFile" />                               
	                            </div>
	                            <label id="error-rejectionReturnFile" class="error-message text-danger"></label>
	                        </div>
		...
		<div class="row">
		    <div class="col">
		        <div class="page_title">
		            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Rejection & Return MIS (Electronic)
		        </div>
		    </div>
		</div>
				    ...
				    <div class="col">
						<aui:form id="fileinfo" method="POST" >
							...
							<fieldset class="row mb-3">
			                  ...
			                  <div class="col-sm-12">
			                    <div class="form-check form-check-inline">
			                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios1" value="3" >
			                      <label class="form-check-label ml-1" for="gridRadios1">
			                        NSDL
			                      </label>
			                    </div>
			                    <div class="form-check form-check-inline">
			                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios2" value="17">
			                      <label class="form-check-label ml-1" for="gridRadios2">
			                        Kfintech
			                      </label>
			                    </div>
			                    <div class="form-check disabled form-check-inline">
			                      <input class="form-check-input reportMasterId" type="radio" name="<portlet:namespace/>reportMasterId" id="gridRadios3" value="18" >
			                      <label class="form-check-label ml-1" for="gridRadios3">
			                        CAMS
			                      </label>
			                    </div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="fileUploadInput">
											<input type="file" class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="rejectionReturnFile" />
											<button type="button" class="btn file-btn">Choose File</button>
										</div>
										<label id="error-rejectionReturnFile" class="error-message"></label>
									</div>
								</div>
							</div>
							<button id="upload" class="nps-btn" name="Submit" type="button" disabled="disabled">Save</button>
						</aui:form>
			    	</div>    
			  	</div>
			  	<div class="row mt-2">
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="rejectionReturnFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-rejectionReturnFile").html("Please select a file to upload");
    	    return false;
    	} else if($('input[name="rejectionReturnFile"]').get(0).files[0].name != "Rejection & Return MIS (Electronic).xlsx"){
    		console.log("No files selected.");
    	    $("#error-rejectionReturnFile").html("Please upload Rejection & Return MIS (Electronic).xlsx");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="rejectionReturnFile"').val("");
           		 	$('#remarks').val("");
