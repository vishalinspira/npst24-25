		...
		<portlet:resourceURL id="/grievpending/save" var="savegrievpendingURL"></portlet:resourceURL>
	 ...
	 <div class="row">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Summary of Grievance pending more than 60 days</h4>
                    <div class="content">
						...
						<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
	                        ...
	                        <div class="nps-input-box file-upload">
	                            ...
	                            <div class="file-select">
	                               ...
	                               <input type="file" class="chooseFile" id="chooseFile" name="grievpendingFile" />                               
	                            </div>
	                            <label id="error-grievpendingFile" class="error-message text-danger"></label>
	                        </div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="fileUploadInput">
										<input type="file" class="form-control" name="grievpendingFile" />
										<button type="button" class="btn file-btn">Choose File</button>
									</div>
									<label id="error-grievpendingFile" class="error-message"></label>
								</div>
							</div>
						</div>
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="grievpendingFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-grievpendingFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="grievpendingFile"]').get(0).files[0].name != "Summary of Grievance pending for more than 60 Days.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-grievpendingFile").html("Please upload Summary of Grievance pending for more than 60 Days.xlsx");
		    	    return false;
		    	}
		            ...
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="grievpendingFile"').val("");
