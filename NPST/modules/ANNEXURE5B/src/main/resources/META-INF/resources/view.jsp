<%@page import="ANNEXURE5B.constants.ANNEXURE5BPortletKeys"%>
<%@ include file="/init.jsp" %>

<!-- <portlet:resourceURL id="/annexureiva/save" var="annexureivaURL"></portlet:resourceURL> -->

<portlet:resourceURL id="<%=ANNEXURE5BPortletKeys.SAVEANNEXURE5B%>" var="saveAnnexureVBURL" />
<!-- 1. -->
<!-- Modal -->
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />ANNEXURE 5B
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="annexurevb" />
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="annexurevb"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-votingreport").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="annexurevb"]').get(0).files[0].name != "ANNEXURE-5B.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-votingreport").html("Please upload ANNEXURE-5B.xlsx");
	    	    return false;
	    	}
