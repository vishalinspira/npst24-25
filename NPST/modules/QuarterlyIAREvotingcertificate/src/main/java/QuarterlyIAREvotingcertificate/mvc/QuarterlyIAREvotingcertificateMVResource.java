package QuarterlyIAREvotingcertificate.mvc;
...
import QuarterlyIAREvotingcertificate.constants.QuarterlyIAREvotingcertificatePortletKeys;


@Component(property = { 
		"javax.portlet.name=" + QuarterlyIAREvotingcertificatePortletKeys.QUARTERLYIAREVOTINGCERTIFICATE,
		"mvc.command.name=/pdfIARevotingURL/data"
		}, 
service = MVCResourceCommand.class)

public class QuarterlyIAREvotingcertificateMVResource implements MVCResourceCommand{
	
private static Log _log = LogFactoryUtil.getLog(QuarterlyIAREvotingcertificateMVResource.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
        _log.info("QuarterlyIAREvotingcertificatePortletKeys fileUpload:::::::::::::::::::::::::::");
		...
		String fileName = uploadPortletRequest.getFileName("iarevoting");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("iarevoting");

		String mimeType = uploadPortletRequest.getContentType("iarevoting");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("iarevoting");
