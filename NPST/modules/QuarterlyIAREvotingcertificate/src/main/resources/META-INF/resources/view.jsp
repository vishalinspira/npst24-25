...
<!-- <portlet:resourceURL id="/saveFinalIntimationNPSURL/data" var="pdfIARevotingURL" />  -->

<portlet:resourceURL id="/pdfIARevotingURL/data" var="pdfIARevotingURL"></portlet:resourceURL>
               ...
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="iarevoting" />
                     </div>
                     <label id="error-iarevoting" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="iarevoting"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-iarevoting").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="iarevoting"]').get(0).files[0].name != "Quaterly Internal Audit Report.pdf"){
    		console.log("No files selected.");
    	    $("#error-iarevoting").html("Please upload Quaterly Internal Audit Report.pdf");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-iarevoting").html("");
        $.ajax({
            url: '${pdfIARevotingURL}', 
            type: 'POST',
            data: fd,
