...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<portlet:resourceURL id="/valuationrepotb/save" var="savevaluationrepotbURL"></portlet:resourceURL>
                    ...
                    <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile" name="valuationrepotbFile" />                               
                            </div>
                            <label id="error-valuationrepotbFile" class="error-message text-danger"></label>
                        </div>
 	...
 	<div class="row">
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="valuationrepotbFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-valuationrepotbFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="valuationrepotbFile"]').get(0).files[0].name != "valuation_tb.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-valuationrepotbFile").html("Please upload valuation_tb.xlsx");
		    	    return false;
		    	}
		        ...
		        $(".content").hide();
		        $(".animaion").show();
		        $("#error-valuationrepotbFile").html("");
		        $.ajax({
		            url: '<%=savevaluationrepotbURL %>',  
		            type: 'POST',
		            data: fd,
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="valuationrepotbFile"').val("");
		           		 	$('#remarks').val("");
