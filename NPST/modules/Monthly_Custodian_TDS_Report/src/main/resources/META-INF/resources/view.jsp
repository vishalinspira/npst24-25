<%@page import="Monthly_Custodian_TDS_Report.constants.Monthly_Custodian_TDS_ReportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Monthly_Custodian_TDS_ReportPortletKeys.pfm%>" var="pfmResourceURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="custodianTDSFile" />
                           </div>
                           <label id="error-custodianTDSFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="custodianTDSFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-custodianTDSFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="custodianTDSFile"]').get(0).files[0].name != "TDS report - Custodian.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-custodianTDSFile").html("Please upload TDS report - Custodian.xlsx");
	    	    return false;
	    	}
	        ...
	        $.ajax({
	            ...
	            success:function(data){
	            	...
	            	if(data.status){
	           		 	...
	           		 	$(".formrow").show();
	           		 	$('input[name="custodianTDSFile"').val("");
		           		/* setTimeout(function() {
