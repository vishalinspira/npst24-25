...
import nps.common.service.util.IntermediataryRoleUtil;
...
@Component(
		...
		property = {
				...
				"mvc.command.name=" + FinalIntimation_NPSPortletKeys.SAVE_FINALINTIMATION_NPS,
		},
		service = MVCResourceCommand.class
)

public class FinalIntimation_NPS implements MVCResourceCommand{

	private static Log _log = LogFactoryUtil.getLog(FinalIntimation_NPS.class);
	
	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws PortletException {
		_log.info("FinalIntimation_NPSMvcResources Serve Resource method");
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String cra = IntermediataryRoleUtil.getUserIntermediataryRole(themeDisplay.getCompanyId(), userId);
		/*
		 * if(reportMasterId == 8) { cra = "NSDL"; } else if(reportMasterId == 21){ cra
		 * = "Kfintech"; }
		 */
		_log.info("cra ************" + cra);
		...
		_log.info("welocme to::::::::::::::::::::::::::::resultJsonObject::::::");
		
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
		ArrayList <String> list = new ArrayList<String>();
	      list.add("PAO_Grievance");
	      list.add("Reg_Lite");
		...
		if(resultJsonObject.getBoolean("status")) {
			...
			GrievanceFinalIntimPaoLocalServiceUtil.deleteGrievanceFinalIntimPaoByReportUploadLogId(reportUploadLogId);
			GrievanceFinalIntimregliteLocalServiceUtil.deleteGrievanceFinalIntimregliteByReportUploadLogId(reportUploadLogId);
			...
			if (!isexcelhaserror) {
				...
				try {
					...
					stream.close();
					errorExcel.close();
					downloadUrl = fileUploadfile(themeDisplay, filePath, filename, resourceRequest);
				} catch (Exception e) {
					 _log.error(e);
				} 
	...
	public String fileUploadfile(ThemeDisplay themeDisplay, String filepath, String filename,
