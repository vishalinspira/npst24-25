<%@page import="valuation_rep_cg.constants.Valuation_rep_cgPortletKeys"%>
<%@ include file="/init.jsp" %>

<!-- <portlet:resourceURL id="/annexureiva/save" var="annexureivaURL"></portlet:resourceURL> -->

 <portlet:resourceURL id="<%=Valuation_rep_cgPortletKeys.saveValuation_rap_cg%>" var="savesaveValuation_rap_cgURL" />
<!-- 1. -->
<!-- Modal -->
		<style>
			.modal {
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="valuation_rep_cg" />
                           </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />valuation_rep_cg_18-November-2021
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="valuation_rep_cg" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-valuation_rep_cg" class="error-message"></label>
							</div>
						</div>
					</div>
	...
	$(function(){
	    $('#upload').on('click', function(){
	        ...
	        $.ajax({
	            ...
	            contentType: false,
	            cache: false,
	            url: '${savesaveValuation_rap_cgURL}',
	            data: formData,
