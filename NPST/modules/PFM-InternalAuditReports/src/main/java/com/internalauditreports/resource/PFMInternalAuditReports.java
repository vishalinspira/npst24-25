package com.internalauditreports.resource;

import com.daily.average.service.service.ReportUploadLogPFMAMPFRDALocalServiceUtil;
import com.internalauditreports.constants.PFMInternalAuditReportsPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + PFMInternalAuditReportsPortletKeys.PFMINTERNALAUDITREPORTS,
		"mvc.command.name=" + PFMInternalAuditReportsPortletKeys.iarDocumentUpload,
		}, 
service = MVCResourceCommand.class)

public class PFMInternalAuditReports implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(PFMInternalAuditReports.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
			...
			docFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "iarDocFile");
			Long pdfFileEntryId = 0l;
			pdfFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "iarPDFFile");
