...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<portlet:resourceURL id="/qrreport/save" var="saveqrreportURL"></portlet:resourceURL>
                    ...
                    <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile" name="qrreportFile" />                               
                            </div>
                            <label id="error-qrreportFile" class="error-message text-danger"></label>
                        </div>
...
<script type="text/javascript">
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="qrreportFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-qrreportFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="qrreportFile"]').get(0).files[0].name != "Quaterly Reports.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-qrreportFile").html("Please upload Quaterly Reports.xlsx");
		    	    return false;
		    	}
