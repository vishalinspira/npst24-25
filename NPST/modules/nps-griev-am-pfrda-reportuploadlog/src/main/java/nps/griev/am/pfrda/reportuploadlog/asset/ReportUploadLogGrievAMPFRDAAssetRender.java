...
public class ReportUploadLogGrievAMPFRDAAssetRender extends BaseJSPAssetRenderer<ReportUploadLogGrievAMPFRDA> {
	private final ReportUploadLogGrievAMPFRDA reportUploadLogCustAMPFRDA;
	
	@Reference
    UserLocalService userLocalService;
	
	public ReportUploadLogGrievAMPFRDAAssetRender(ReportUploadLogGrievAMPFRDA reportUploadLogCustAMPFRDA) {
		this.reportUploadLogCustAMPFRDA = reportUploadLogCustAMPFRDA;
	}
	
	@Override
	public ReportUploadLogGrievAMPFRDA getAssetObject() {
	...
	Log _log = LogFactoryUtil.getLog(ReportUploadLogGrievAMPFRDAAssetRender.class);
