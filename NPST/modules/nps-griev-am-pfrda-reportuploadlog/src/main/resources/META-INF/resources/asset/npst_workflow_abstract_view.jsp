...
<%
	...
	boolean isGrievancesGM = RoleServiceUtil.hasUserRole(user.getUserId(), user.getCompanyId(), NPSTRoleConstants.GRIEVANCES_GM, false);
...
<% for(int i=0; i<urlArray.length();i++){
	...
	<%}else{
		try{
			long fileId=Long.valueOf(object.getString("fileEntryId"));
			 dlFileEntry= DLFileEntryLocalServiceUtil.getDLFileEntry(fileId);
