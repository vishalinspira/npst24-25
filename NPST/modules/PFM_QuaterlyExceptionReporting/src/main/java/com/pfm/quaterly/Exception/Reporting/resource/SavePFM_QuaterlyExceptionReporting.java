package com.pfm.quaterly.Exception.Reporting.resource;
...
import com.pfm.quaterly.Exception.Reporting.constants.PFM_QuaterlyExceptionReportingPortletKeys;
...
@Component(
		immediate = true,
		property = {
				"javax.portlet.name=" + PFM_QuaterlyExceptionReportingPortletKeys.PFM_QUATERLYEXCEPTIONREPORTING,
...
public class SavePFM_QuaterlyExceptionReporting implements MVCResourceCommand{
	Log _log = LogFactoryUtil.getLog(getClass());
	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws PortletException {
		_log.info("in SavePFM_QuaterlyExceptionReporting");
