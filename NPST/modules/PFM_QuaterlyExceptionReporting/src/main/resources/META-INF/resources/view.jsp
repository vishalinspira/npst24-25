        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Quarterly Exception reporting</h4>
                    <div class="content">
					...
					<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
                        ...
                        <div class="nps-input-box file-upload file-upload_i">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" id="chooseFile" name="unaditedfinancial" accept=".pdf"/>                               
                            </div>
                        ...
                        <div class="nps-input-box file-upload file-upload_ii">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" id="chooseFile_i" name="unaditedfinancial_i" accept=".pdf"/>                               
                            </div>
