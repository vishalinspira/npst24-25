...
<portlet:resourceURL id="/PDFURLAnnexureelevenAuditorCertificate/save" var="PDFURLAnnexureelevenAuditorCertificateURL" />
<portlet:resourceURL id="/GetReportOfAnnexureEleven/save" var="GetReportOfAnnexureElevenURL" />  
<!-- Modal -->
         ...
         <div class="nps-report">
            <div class="form_block">
               <div class=" content">
                  ...
                  <h4>Concurrent Audit Certificate</h4>
...
function getreportUploadLogId(){
	...
	$.ajax({
        url: '${GetReportOfAnnexureElevenURL}', 
        type: 'POST',
        data: fd,
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexureelevenacFile"]').get(0).files.length === 0) {
    	    ...
    	    return false;
    	}else if($('input[name="annexureelevenacFile"]').get(0).files[0].name != "Concurrent Audit Certificate.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexureelevenacFile").html("Please upload Concurrent Audit Certificate.pdf");
    	    return false;
    	}
        ...
        $.ajax({
            url: '${PDFURLAnnexureelevenAuditorCertificateURL}', 
            type: 'POST',
            data: fd,
            success:function(data){
            	$(".content").show();
