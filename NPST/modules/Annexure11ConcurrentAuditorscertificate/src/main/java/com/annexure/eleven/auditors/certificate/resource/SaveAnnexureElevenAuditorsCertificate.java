package com.annexure.eleven.auditors.certificate.resource;
...
@Component(property = { "javax.portlet.name=" +  Annexure11ConcurrentAuditorscertificatePortletKeys.ANNEXURE11CONCURRENTAUDITORSCERTIFICATE,
"mvc.command.name=/PDFURLAnnexureelevenAuditorCertificate/save",}, service = MVCResourceCommand.class)
public class SaveAnnexureElevenAuditorsCertificate implements MVCResourceCommand{
