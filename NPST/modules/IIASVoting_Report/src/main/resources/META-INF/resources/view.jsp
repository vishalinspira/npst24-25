<%@page import="IIASVoting_Report.resource.CheckRoleUtil"%>
<%@page import="IIASVoting_Report.constants.IIASVoting_ReportPortletKeys"%>
...
<portlet:resourceURL id="<%=IIASVoting_ReportPortletKeys.saveiiasVotingreport%>" var="savevotingReportURL" /> 
<!-- 1. -->
<!-- Modal -->
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="votingreport" />
                           </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> IIAS voting report
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="votingreport" />
