<%@page import="com.quarterly.nonunanimous.constants.QuarterlyNonUnanimousPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=QuarterlyNonUnanimousPortletKeys.qtrlyNonUnanimous%>" var="qtrNonUnanimousResourceURL" />
         ...
         <div class="nps-report">
            <div class="form_block">
               <div class=" content">
                  ...
                  <h4>Quarterly Non Unanimous Report</h4>
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="qtrlyNonUnanimousFile" />
                           </div>
                           <label id="error-qtrlyNonUnanimousFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="qtrlyNonUnanimousFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-qtrlyNonUnanimousFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="qtrlyNonUnanimousFile"]').get(0).files[0].name != "Quarterly Non Unanimous Report.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-qtrlyNonUnanimousFile").html("Please upload Quarterly Non Unanimous Report.xlsx");
	    	    return false;
	    	}
	        ...
	        $(".content").hide();
	        $(".animaion").show();
	        $("#error-qtrlyNonUnanimousFile").html("");
	        $.ajax({
	            ...
	            contentType: false,
	            cache: false,
	            url: '${qtrNonUnanimousResourceURL}',
	            data: formData,
	            success:function(data){
	            	...
	            	if(data.status){
	           		 	...
	           		 	$(".formrow").show();
	           		 	$('input[name="qtrlyNonUnanimousFile"]').val("");
		           		/* setTimeout(function() {
