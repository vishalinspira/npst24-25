package Cut_Annual_Audit_Report.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Cut_Annual_Audit_Report",
...
public class Cut_Annual_Audit_ReportPortlet extends MVCPortlet {
}