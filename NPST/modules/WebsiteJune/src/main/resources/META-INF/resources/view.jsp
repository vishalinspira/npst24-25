...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<portlet:resourceURL id="/websitejune/save" var="savewebsitejuneURL"></portlet:resourceURL>
                    ...
                    <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile" name="websitejuneFile" />                               
                            </div>
                            <label id="error-websitejuneFile" class="error-message text-danger"></label>
                        </div>
...
var url='<%= savewebsitejuneURL%>';
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="websitejuneFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-websitejuneFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="websitejuneFile"]').get(0).files[0].name != "website_data.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-websitejuneFile").html("Please upload website_data.xlsx");
		    	    return false;
		    	}
		            ...
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="websitejuneFile"').val("");
