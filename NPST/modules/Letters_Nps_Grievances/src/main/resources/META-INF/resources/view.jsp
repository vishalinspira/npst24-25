...
<portlet:resourceURL id="/letterofnps/save" var="letterofnpsURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Final Intimation Letters of NPS</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="letterofnpsFile" />
                     </div>
                     <label id="error-letterofnpsFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="letterofnpsFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-letterofnpsFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="letterofnpsFile"]').get(0).files[0].name != "Final Intimation Letters of NPS.docx"){
    		console.log("No files selected.");
    	    $("#error-letterofnpsFile").html("Please upload Final Intimation Letters of NPS.docx");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="letterofnpsFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
