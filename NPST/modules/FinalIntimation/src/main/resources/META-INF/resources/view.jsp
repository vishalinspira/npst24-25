<%@page import="com.finalintimation.constants.FinalIntimationPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=FinalIntimationPortletKeys.finalIntimationDocumentUpload%>" var="finalIntimationResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Final Intimation Forwarding To PFRDA</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="finalIntimationPDFFile" accept=".pdf"/>
                     </div>
                     <label id="error-finalIntimationPDFFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="finalIntimationPDFFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-finalIntimationPDFFile").html("Please select a file to upload");
    	    return false;
    	}
    	/* else if($('input[name="finalIntimationPDFFile"]').get(0).files[0].name != "Final Intimation forwarding to PFRDA.pdf"){
    		console.log("No files selected.");
    	    $("#error-finalIntimationPDFFile").html("Please upload Final Intimation forwarding to PFRDA.pdf");
    	    return false;
    	} */
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-finalIntimationPDFFile").html("");
        $.ajax({
            url: '${finalIntimationResourceURL}', 
            type: 'POST',
            data: fd,
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	//$('input[name="stewardshipFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		//console.log(data);
