package com.finalintimation.resource;
...
import com.finalintimation.constants.FinalIntimationPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + FinalIntimationPortletKeys.FINALINTIMATION,
		"mvc.command.name=" + FinalIntimationPortletKeys.finalIntimationDocumentUpload,
		}, 
service = MVCResourceCommand.class)

public class FinalIntimationforPFRDA implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(FinalIntimationforPFRDA.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
			...
			//uploadFILETOFOLDER(themeDisplay, resourceRequest, "annualProxyReportExcelFile");
			Long fileEntryId = 0l;
			fileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "finalIntimationPDFFile");
