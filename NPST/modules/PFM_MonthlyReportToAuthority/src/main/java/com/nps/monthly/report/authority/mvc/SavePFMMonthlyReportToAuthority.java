package com.nps.monthly.report.authority.mvc;
...
import com.nps.monthly.report.authority.constants.PFM_MonthlyReportToAuthorityPortletKeys;
...
@Component(
		immediate = true,
		property = {
				"javax.portlet.name=" + PFM_MonthlyReportToAuthorityPortletKeys.PFM_MONTHLYREPORTTOAUTHORITY,
				"mvc.command.name=/savepmra/data",
		},
		service = MVCResourceCommand.class
		)
public class SavePFMMonthlyReportToAuthority implements MVCResourceCommand{
	@Override
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		long fileidi = uploadFILETOFOLDER(themeDisplay, resourceRequest,"unaditedfinancial_docs");
		long fileidii = uploadFILETOFOLDER(themeDisplay, resourceRequest,"unaditedfinancial_xlsx");
