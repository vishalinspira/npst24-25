        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Monthly report to Authority</h4>
                    <div class="content">
					...
					<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
                        ...
                        <div class="nps-input-box file-upload file-upload_ii">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_i" name="unaditedfinancial_docs"  accept=".pdf"/>                               
                            </div>
                            <label id="error-unaditedfinancial_docs" class="error-message text-danger"></label>
                        </div>
                        ...
                        <div class="nps-input-box file-upload file-upload_iii">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_ii" name="unaditedfinancial_xlsx"  accept=".xlsx"/>                               
                            </div>
                            <label id="error-unaditedfinancial_xlsx" class="error-message text-danger"></label>
                        </div>
...
$(function(){
    $('#upload').on('click', function(){
    	...
    	if ($('input[name="unaditedfinancial_docs"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-unaditedfinancial_docs").html("Please select a file to upload");
    	    return false;
    	}
    	
    	if ($('input[name="unaditedfinancial_xlsx"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-unaditedfinancial_xlsx").html("Please select a file to upload");
    	    return false;
    	}
    	/* else if($('input[name="unaditedfinancial_docs"]').get(0).files[0].name != "Half yearly unaudited financial report.pdf"){
    		console.log("No files selected.");
    	    $("#error-unaditedfinancial_docs").html("Please upload Half yearly unaudited financial report.pdf");
    	    return false;
    	}  */
        ...
        $("#error-unaditedfinancial_docs").html("");
        $("#error-unaditedfinancial_xlsx").html("");
