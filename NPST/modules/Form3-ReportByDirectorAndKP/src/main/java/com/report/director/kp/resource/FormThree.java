...
import com.report.director.kp.constants.Form3ReportByDirectorAndKPPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + Form3ReportByDirectorAndKPPortletKeys.FORM3REPORTBYDIRECTORANDKP,
		"mvc.command.name=" + Form3ReportByDirectorAndKPPortletKeys.formThree,
		}, 
service = MVCResourceCommand.class)

public class FormThree implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(FormThree.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("formThreeFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("formThreeFile");

		String mimeType = uploadPortletRequest.getContentType("formThreeFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("formThreeFile");
		...
		String description = "formThreeFile";
