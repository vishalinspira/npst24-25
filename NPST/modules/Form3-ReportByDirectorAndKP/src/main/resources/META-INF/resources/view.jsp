<%@page import="com.report.director.kp.constants.Form3ReportByDirectorAndKPPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Form3ReportByDirectorAndKPPortletKeys.formThree%>" var="formThreeResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Form 3 Report by Director and Key Personnel on instances of self dealing or front running.</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="formThreeFile" />
                     </div>
                     <label id="error-formThreeFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="formThreeFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-formThreeFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="formThreeFile"]').get(0).files[0].name != "Form 3 Report by Director and Key Personnel on instances of self dealing or front running.pdf"){
    		console.log("No files selected.");
    	    $("#error-formThreeFile").html("Please upload Form 3 Report by Director and Key Personnel on instances of self dealing or front running.pdf");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-formThreeFile").html("");
        $.ajax({
            url: '${formThreeResourceURL}', 
            type: 'POST',
            data: fd,
