<%@page import="com.compcert.halfyearly.constants.ComplianceCertificateAtHalfYearlyIntervalPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=ComplianceCertificateAtHalfYearlyIntervalPortletKeys.compCertAtHalfYearly%>" var="comCerHalfYearlyResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Half Yearly Compliance Certificate</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="compCertHalfYearlyFile" />
                     </div>
                     <label id="error-compCertHalfYearlyFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="compCertHalfYearlyFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-compCertHalfYearlyFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="compCertHalfYearlyFile"]').get(0).files[0].name != "Half yearly Compliance certificate.pdf"){
    		console.log("No files selected.");
    	    $("#error-compCertHalfYearlyFile").html("Please upload Half yearly Compliance certificate.pdf");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-compCertHalfYearlyFile").html("");
        $.ajax({
            url: '${comCerHalfYearlyResourceURL}', 
            type: 'POST',
            data: fd,
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="compCertHalfYearlyFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
