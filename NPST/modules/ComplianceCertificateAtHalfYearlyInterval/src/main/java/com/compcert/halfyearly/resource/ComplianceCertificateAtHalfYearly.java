package com.compcert.halfyearly.resource;

import com.compcert.halfyearly.constants.ComplianceCertificateAtHalfYearlyIntervalPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + ComplianceCertificateAtHalfYearlyIntervalPortletKeys.COMPLIANCECERTIFICATEATHALFYEARLYINTERVAL,
		"mvc.command.name=" + ComplianceCertificateAtHalfYearlyIntervalPortletKeys.compCertAtHalfYearly,
		}, 
service = MVCResourceCommand.class)

public class ComplianceCertificateAtHalfYearly implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(ComplianceCertificateAtHalfYearly.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("compCertHalfYearlyFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("compCertHalfYearlyFile");

		String mimeType = uploadPortletRequest.getContentType("compCertHalfYearlyFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("compCertHalfYearlyFile");
		...
		String description = "compCertHalfYearlyFile";
