...
<portlet:resourceURL id="/valuationsg/save" var="saveValuationsgURL"></portlet:resourceURL>
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="valuationsgFile" />
                           </div>
                           <label id="error-valuationsgFile" class="error-message"></label>
                        </div>
		...
		<div class="row">
		    <div class="col">
		        <div class="page_title">
		            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Valuation Report SG
		        </div>
		    </div>
		</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="fileUploadInput">
											<input type="file" class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="valuationsgFile" />
...
$(function(){
    $('#upload').on('click', function(){
    	if ($('input[name="valuationsgFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-valuationsgFile").html("Please select a file to upload");
    	    return false;
    	} else if($('input[name="valuationsgFile"]').get(0).files[0].name != "valuation_sg.xlsx"){
    		console.log("No files selected.");
    	    $("#error-valuationsgFile").html("Please upload valuation_sg.xlsx");
    	    return false;
    	}
        ...
        $(".content").hide();
        $(".animaion").show();
        $("#error-valuationsgFile").html("");
        $.ajax({
            url: '<%=saveValuationsgURL %>',  
            type: 'POST',
            data: fd,
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="valuationsgFile"').val("");
           		 	$('#remarks').val("");
	           		/* setTimeout(function() {
