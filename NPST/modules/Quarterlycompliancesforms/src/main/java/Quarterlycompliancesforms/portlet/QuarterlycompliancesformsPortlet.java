package Quarterlycompliancesforms.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Quarterlycompliancesforms",
...
public class QuarterlycompliancesformsPortlet extends MVCPortlet {
}