package grievance.top.five.entities.month.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=GrievanceTopFiveEntitiesMonth",
...
public class GrievanceTopFiveEntitiesMonthPortlet extends MVCPortlet {
}