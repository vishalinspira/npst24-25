...
@Component(property = { 
		...
		"mvc.command.name=" + An16AMInternalAuditReportPortletKeys.amInternalAuditReport
		}, 
service = MVCResourceCommand.class)

public class AmInternalAuditReport implements MVCResourceCommand{
	private final Log _log = LogFactoryUtil.getLog(AmInternalAuditReport.class);
