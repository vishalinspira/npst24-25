<%@page import="An16.AM.InternalAuditReport.constants.An16AMInternalAuditReportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=An16AMInternalAuditReportPortletKeys.amInternalAuditReport%>" var="PDFURL" />
<portlet:resourceURL id="<%=An16AMInternalAuditReportPortletKeys.getReportUpload%>" var="GetReportURL" />  
        ...
        <div class="row">
	     <div class="col-12">
	        <div class="text-right">
	            <p  class="back_btn"><a class="backbtn" href="/web/guest/periodically-am-report"><i class="fas fa-arrow-left text-white pr-3"></i>Back</a></p>
	        </div>
	     </div>
	  </div>
      <div class="row">
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexurexVIFile"]').get(0).files.length === 0) {
    	    ...
    	    return false;
    	}else if($('input[name="annexurexVIFile"]').get(0).files[0].name != "Internal Audit Report.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexurexiiiFile").html("Internal Audit Report.pdf");
    	    return false;
    	}
