...
@Component(property = { "javax.portlet.name=" + Annexure13CompliancecertificatePortletKeys.ANNEXURE13COMPLIANCECERTIFICATE,
"mvc.command.name="+ Annexure13CompliancecertificatePortletKeys.GETAnnexure13Compliancecertificate,}, service = MVCResourceCommand.class)
