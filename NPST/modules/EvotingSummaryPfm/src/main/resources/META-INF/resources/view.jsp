...
<portlet:resourceURL id="/evotingsummary/save" var="saveevotingsummaryURL"></portlet:resourceURL>
	                ...
	                <div class="nps-input-box mt-0">
                       ...
                       <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" class="chooseFile" id="chooseFile" name="evotingsummaryFile" />                               
                           </div>
                           <label id="error-evotingsummaryFile" class="error-message text-danger"></label>
                       </div>
...
$(function(){
    $('#upload').on('click', function(){
    	if ($('input[name="evotingsummaryFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-evotingsummaryFile").html("Please select a file to upload");
    	    return false;
    	} else if($('input[name="evotingsummaryFile"]').get(0).files[0].name != "Quarterly Evoting Summary.xlsx"){
    		console.log("No files selected.");
    	    $("#error-evotingsummaryFile").html("Please upload Quarterly Evoting Summary.xlsx");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="evotingsummaryFile"').val("");
           		    $('#remarks').val("");
