...
}, service = PerformanceRepEmailApi.class)


public class PerformanceRepEmailServiceImpl extends RestClient implements PerformanceRepEmailApi {
	...
	public String sendOTP(String emailAddress) {
		...
		String subject = "Performance report form submitted";
		sendEmail("deepak@creanttechnologies.com", emailAddress, subject, body);

		return body;
	}
	
	private static final Log _log = LogFactoryUtil.getLog(PerformanceRepEmailServiceImpl.class);
