...
}, service = ComplianceEmailApi.class)


public class ComplianceEmailSserviceImpl extends RestClient implements ComplianceEmailApi {
	...
	public String sendOTP(String emailAddress) {
		...
		String subject = "Compliance form submitted";
		sendEmail("deepak@creanttechnologies.com", emailAddress, subject, body);

		return body;
	}
	
	private static final Log _log = LogFactoryUtil.getLog(ComplianceEmailSserviceImpl.class);
