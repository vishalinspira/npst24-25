...
import nps.email.api.api.ComplianceSmsApi;
import nps.email.api.props.PropValues;
import nps.email.service.client.RestClient;

@Component(immediate = true, property = {

}, service = ComplianceSmsApi.class) 

public class ComplianceSmsServiceImpl extends RestClient implements ComplianceSmsApi {
	...
	private static final Log _log = LogFactoryUtil.getLog(ComplianceSmsServiceImpl.class);
