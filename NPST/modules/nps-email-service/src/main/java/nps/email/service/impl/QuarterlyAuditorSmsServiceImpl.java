...
import nps.email.api.api.QuarterlyAuditorSmsApi;
import nps.email.api.props.PropValues;
import nps.email.service.client.RestClient;

@Component(immediate = true, property = {

}, service = QuarterlyAuditorSmsApi.class) 

public class QuarterlyAuditorSmsServiceImpl extends RestClient implements QuarterlyAuditorSmsApi {
	...
	private static final Log _log = LogFactoryUtil.getLog(QuarterlyAuditorSmsServiceImpl.class);
