...
}, service = QuarterlyAuditorEmailApi.class)


public class QuarterlyAuditorEmailServiceImpl extends RestClient implements QuarterlyAuditorEmailApi {
	...
	public String sendOTP(String emailAddress) {
		...
		String subject = "Quarterly auditor form submitted";
		sendEmail("deepak@creanttechnologies.com", emailAddress, subject, body);

		return body;
	}

	private static final Log _log = LogFactoryUtil.getLog(QuarterlyAuditorEmailServiceImpl.class);
