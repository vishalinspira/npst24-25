...
}, service = ClosingBalanceSmsApi.class) 

public class ClosingBalanceSmsServiceImpl extends RestClient implements ClosingBalanceSmsApi {
	...
	public void sendFormSubmitSuccessfulSMS(String mobileNo, String name) {
	 ...
	 private static final Log _log = LogFactoryUtil.getLog(ClosingBalanceSmsServiceImpl.class);
