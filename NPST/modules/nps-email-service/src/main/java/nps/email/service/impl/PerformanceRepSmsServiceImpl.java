...
}, service = PerformanceRepSmsApi.class) 

public class PerformanceRepSmsServiceImpl extends RestClient implements PerformanceRepSmsApi {
	...
	private static final Log _log = LogFactoryUtil.getLog(PerformanceRepSmsServiceImpl.class);
