<%@page import="com.halfyearly.iar.constants.HalfYearlyIARPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=HalfYearlyIARPortletKeys.hyIAR%>" var="halfYearIARResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Half Yearly IAR Certificate</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="hyrIARFile" />
                     </div>
                     <label id="error-hyrIARFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="hyrIARFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-hyrIARFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="hyrIARFile"]').get(0).files[0].name != "Half yearly IAR certificate.pdf"){
    		console.log("No files selected.");
    	    $("#error-hyrIARFile").html("Please upload Half yearly IAR certificate.pdf");
    	    return false;
    	}
