package com.halfyearly.iar.resource;
...
@Component(property = { 
		"javax.portlet.name=" + HalfYearlyIARPortletKeys.HALFYEARLYIAR,
		"mvc.command.name=" + HalfYearlyIARPortletKeys.hyIAR,
		}, 
service = MVCResourceCommand.class)

public class HalfYearlyIAR implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(HalfYearlyIAR.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("hyrIARFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("hyrIARFile");

		String mimeType = uploadPortletRequest.getContentType("hyrIARFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("hyrIARFile");
