...
<portlet:renderURL var="employeeFilterURL">
    ...
    <portlet:param name="jspName" value="/view-risk-committee.jsp" />
</portlet:renderURL>
 ...
 String myPfm=null;
	...
	String  pfmName=ParamUtil.getString(request, ManpowerEmployeeFieldName.PFM_NAME);
	 ...
	 if(isNpstUser){
	 		...
	 		manpowerEmployees=ManpowerUtil.getCommitteEmployee(employeeStatus, pfmName, Integer.parseInt(ManpowerStatusConstant.COMMITTEE_MEMBERSHIP_TYPE_RISK));
	 		...
	 		manpowerEmployees=ManpowerUtil.getCommitteEmployee(employeeStatus, myPfm, Integer.parseInt(ManpowerStatusConstant.COMMITTEE_MEMBERSHIP_TYPE_RISK));
	 	}
	 %>
...
<h2 class="text-center"><%=ManpowerHeaderConstant.VIEW_RISK_COMMITTEE %></h2>
...
<table id="directorTable" class="dataTable-table table table-bordered table-responsive">
		<thead>
			<tr class="border">
				...
				<th style="width: 40%;"><%=ManpowerEmployeeFieldLabel.TABLE_VIEW_DESIGNATION%></th>
