package com.exceptionreporting.resource;

import com.daily.average.service.service.ReportUploadLogPFMAMPFRDALocalServiceUtil;
import com.exceptionreporting.constants.ExceptionReportingPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + ExceptionReportingPortletKeys.EXCEPTIONREPORTING,
		"mvc.command.name=" + ExceptionReportingPortletKeys.halfYearlyExceptionReportingDocumentUpload,
		}, 
service = MVCResourceCommand.class)

public class ExceptionReporting implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(ExceptionReporting.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
			...
			docFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "exceptionReportDocFile");
			Long pdfFileEntryId = 0l;
			pdfFileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest, "exceptionReportPDFFile");
