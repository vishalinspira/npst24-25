<%@page import="com.lettersofapy.constants.LettersOfAPYPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=LettersOfAPYPortletKeys.apyLetter%>" var="apyLetterResourceURL" /> 
   ...
   <div class="row">
      <div class="col-lg-7 col-md-10 col-sm-12 col-12">
         <div class="nps-report">
            <div class="content">
               <h4>Final Intimation Letters of APY</h4>
               <aui:form id="fileinfo" method="POST" >
                  ...
                  <div class="nps-input-box file-upload">
                     ...
                     <div class="file-select">
                        ...
                        <input type="file" id="chooseFile" name="apyLetterFile" />
                     </div>
                     <label id="error-apyLetterFile" class="error-message text-danger"></label>
                  </div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="apyLetterFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-apyLetterFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="apyLetterFile"]').get(0).files[0].name != "Final Intimation Letters of APY.docx"){
    		console.log("No files selected.");
    	    $("#error-apyLetterFile").html("Please upload Final Intimation Letters of APY.docx");
    	    return false;
    	}
