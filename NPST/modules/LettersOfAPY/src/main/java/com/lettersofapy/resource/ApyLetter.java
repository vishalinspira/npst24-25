package com.lettersofapy.resource;
...
import com.lettersofapy.constants.LettersOfAPYPortletKeys;
...
@Component(property = { 
		"javax.portlet.name=" + LettersOfAPYPortletKeys.LETTERSOFAPY,
		"mvc.command.name=" + LettersOfAPYPortletKeys.apyLetter,
		}, 
service = MVCResourceCommand.class)

public class ApyLetter implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(ApyLetter.class.getName());
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("apyLetterFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("apyLetterFile");

		String mimeType = uploadPortletRequest.getContentType("apyLetterFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("apyLetterFile");
		...
		String description = "apyLetterFile";
