         ...
         <div class="nps-report">
            <div class="form_block">
               <div class=" content">
                  ...
                  <h4>Quarterly Custodian Bills</h4>
                     <form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="AnnexureFourCustodianExcelFile" accept=".xlsx"/>
                           </div>
                           <label id="error-AnnexureFourCustodianExcelFile" class="error-message text-danger"></label>
                        </div>
                        ...
                        <div class="nps-input-box">
                           <label>Remarks</label>
                           <textarea id="remarks" name="<portlet:namespace/>remarks" rows="4" cols="" maxlength="1000"></textarea>
                        </div>
                        <div class="nps-input-box">
...
/*   $('#chooseFile_1').bind('change', function () {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="AnnexureFourCustodianExcelFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-AnnexureFourCustodianExcelFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="AnnexureFourCustodianExcelFile"]').get(0).files[0].name != "Annexure IV - Custodian.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-AnnexureFourCustodianExcelFile").html("Please upload Annexure IV - Custodian.xlsx");
	    	    return false;
	    	}
	        ...
	        $(".content").hide();
	        $(".animaion").show();
	        $("#error-AnnexureFourCustodianExcelFile").html("");
	        $.ajax({
	            ...
	            contentType: false,
	            cache: false,
	            url: '${saveAnnexureFourCustodianFileExcelURL}',
	            data: formData,
	            success:function(data){
	            	...
	            	if(data.status){
	           		 	...
	           		 	$(".formrow").show();
	           		 	$('input[name="AnnexureFourCustodianExcelFile"').val("");
