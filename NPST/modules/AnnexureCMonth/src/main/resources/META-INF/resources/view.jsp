...
<portlet:resourceURL id="annexCResourceExcelURl/Save" var="annexCResourceExcelURl" /> 
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="monthFile" />
                           </div>
                           <label id="error-monthFile" class="error-message text-danger"></label>
                        </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Annexure C - Month
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="monthFile" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-monthFile" class="error-message"></label>
							</div>
						</div>
					</div>
...
$(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="monthFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-monthFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="monthFile"]').get(0).files[0].name != "Annexure C-September_2021.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-monthFile").html("Please upload Annexure C-September_2021.xlsx");
	    	    return false;
	    	}
