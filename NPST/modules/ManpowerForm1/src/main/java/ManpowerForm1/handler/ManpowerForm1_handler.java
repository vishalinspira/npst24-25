...
public class ManpowerForm1_handler extends BaseWorkflowHandler<Manpowerform_i>{
Manpowerform_iLocalService manpowerform_iLocalService;
	
	@Reference(unbind = "-")
	protected void setManpowerform_iLocalService(Manpowerform_iLocalService manpowerform_iLocalService) {
		this.manpowerform_iLocalService = manpowerform_iLocalService;
	}
	...
	@Override
	public Manpowerform_i updateStatus(int status, Map<String, Serializable> workflowContext)
		...
		Manpowerform_i manpowerform_i = manpowerform_iLocalService.updateManpowerform_iStatus(id, userId, status, serviceContext, WorkflowContextUtil.convert(workflowContext));
		return manpowerform_i;
	}
	Log _log = LogFactoryUtil.getLog(ManpowerForm1_handler.class);
