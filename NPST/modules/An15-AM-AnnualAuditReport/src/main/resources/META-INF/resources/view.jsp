<%@page import="An15.AM.AnnualAuditReport.constants.An15AMAnnualAuditReportPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=An15AMAnnualAuditReportPortletKeys.amAuditReport%>" var="PDFURLAnnexure" />
<portlet:resourceURL id="<%=An15AMAnnualAuditReportPortletKeys.getReportUpload%>" var="GetReportURL" />  
      ...
      <div class="row">
          <div class="col-lg-7 col-md-10 col-sm-12 col-12">
              <div class="nps-report">
                  <h4>Annexure 15 Annual Audit Report</h4>
                  <div class="content">
						...
						<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
	                      ...
	                      <div class="nps-input-box file-upload">
	                          ...
	                          <div class="file-select">
	                             ...
	                             <input type="file" id="chooseFile" name="annexFifteenFile" />
	                          </div>
	                          <label id="error-annexFifteenFile" class="error-message text-danger"></label>
	                      </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Annexure 15 Annual Audit Report
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="annexFifteenFile" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-annexFifteenFile" class="error-message"></label>
							</div>
						</div>
					</div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexFifteenFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-annexFifteenFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="annexFifteenFile"]').get(0).files[0].name != "Annexure 15 Annual Audit Report-converted.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexFifteenFile").html("Please upload Annexure 15 Annual Audit Report-converted.pdf");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="annexFifteenFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
