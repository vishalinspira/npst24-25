package com.annex15.am.annualauditreport.resource;
...
import An15.AM.AnnualAuditReport.constants.An15AMAnnualAuditReportPortletKeys;

@Component(property = { 
		"javax.portlet.name=" + An15AMAnnualAuditReportPortletKeys.AN15AMANNUALAUDITREPORT,
		"mvc.command.name=" + An15AMAnnualAuditReportPortletKeys.amAuditReport,
		}, 
service = MVCResourceCommand.class)

public class AmAnnualAuditReport implements MVCResourceCommand {
	
	private static Log _log = LogFactoryUtil.getLog(AmAnnualAuditReport.class);
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("annexFifteenFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("annexFifteenFile");

		String mimeType = uploadPortletRequest.getContentType("annexFifteenFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("annexFifteenFile");
		...
		String description = "annexFifteenFile";
