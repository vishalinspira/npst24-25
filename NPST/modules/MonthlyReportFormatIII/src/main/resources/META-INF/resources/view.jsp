<%@page import="MonthlyReportFormatIII.constants.MonthlyReportFormatIIIPortletKeys"%>
<%@ include file="/init.jsp" %>

<!-- <portlet:resourceURL id="/annexureiva/save" var="annexureivaURL"></portlet:resourceURL> -->
<portlet:resourceURL id="<%=MonthlyReportFormatIIIPortletKeys.saveMONTHLYREPORTFORMATIII%>" var="saveMonthlyreportIIIURL" /> 
<!-- 1. -->
<!-- Modal -->
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Monthly ReportFormat
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="monthlyreportiii" />
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="monthlyreportiii"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-votingreport").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="monthlyreportiii"]').get(0).files[0].name !="Monthly Report Format.xlsx"){
	    		console.log("No files selected.");
