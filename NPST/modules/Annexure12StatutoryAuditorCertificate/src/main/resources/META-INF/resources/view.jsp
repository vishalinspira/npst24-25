<%@page import="Annexure12StatutoryAuditorCertificate.constants.Annexure12StatutoryAuditorCertificatePortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=Annexure12StatutoryAuditorCertificatePortletKeys.PDFUploadAnnexure12%>" var="UplaodAnnexurPDFURL" /> 
<portlet:resourceURL id="<%=Annexure12StatutoryAuditorCertificatePortletKeys.GETReportlogdetailsURL%>" var="getreportlogdetailsURL"/>
<!-- Modal -->
            ...
            <div class="form_block">
               <div class=" content">
                  <div class="row formrow">
                   <h4>Statutory Auditor Certificate</h4>
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="annexurexiiFile" />
                           </div>
                           <label id="error-annexurexiiFile" class="error-message text-danger"></label>
                        </div>
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" />Statutory Auditor Certificate
	        </div>
	    </div>
	</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<div class="fileUploadInput">
									<input type="file" class="form-control" name="annexurexiiFile" />
									<button type="button" class="btn file-btn">Choose File</button>
								</div>
								<label id="error-annexurexiiFile" class="error-message"></label>
							</div>
						</div>
					</div>
...
$(function(){
    ...
    $('#upload').on('click', function(){
    	if ($('input[name="annexurexiiFile"]').get(0).files.length === 0) {
    	    console.log("No files selected.");
    	    $("#error-annexurexiiFile").html("Please select a file to upload");
    	    return false;
    	}else if($('input[name="annexurexiiFile"]').get(0).files[0].name != "Statutory Auditor Certificate.pdf"){
    		console.log("No files selected.");
    	    $("#error-annexurexiiFile").html("Please upload Statutory Auditor Certificate.pdf");
    	    return false;
    	}
            ...
            success:function(data){
            	...
            	if(data.status){
            		//var pdfURL = data.pdfURL;
           		 	...
           		 	$(".formrow").show();
           		 	$('input[name="annexurexiiFile"').val("");
           		 	$('#remarks').val("");
            	}else{
            		console.log(data);
