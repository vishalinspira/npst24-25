package Annexure12StatutoryAuditorCertificate.resource;
...
import Annexure12StatutoryAuditorCertificate.constants.Annexure12StatutoryAuditorCertificatePortletKeys;

@Component(property = { 
		"javax.portlet.name=" +  Annexure12StatutoryAuditorCertificatePortletKeys.ANNEXURE12STATUTORYAUDITORCERTIFICATE,
		"mvc.command.name=" + Annexure12StatutoryAuditorCertificatePortletKeys.PDFUploadAnnexure12,
		}, 
service = MVCResourceCommand.class)

public class Annexure12StatutoryAuditorCertificateMVCResource implements MVCResourceCommand {
	@Override
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("annexurexiiFile");
		
		_log.info("fileName:::::::::::::::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("annexurexiiFile");

		String mimeType = uploadPortletRequest.getContentType("annexurexiiFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("annexurexiiFile");
		...
		String description = "annexurexiiFile";
