...
@Component(property = { "javax.portlet.name=" +  Annexure12StatutoryAuditorCertificatePortletKeys.ANNEXURE12STATUTORYAUDITORCERTIFICATE,
"mvc.command.name=" + Annexure12StatutoryAuditorCertificatePortletKeys.GETReportlogdetailsURL, }, service = MVCResourceCommand.class)
