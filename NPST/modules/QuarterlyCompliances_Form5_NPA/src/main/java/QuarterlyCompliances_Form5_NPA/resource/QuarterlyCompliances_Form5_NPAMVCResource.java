package QuarterlyCompliances_Form5_NPA.resource;
...
import compliance.service.service.persistence.QuaeterlyfromfivenpaUtil;

@Component(property = { 
		"javax.portlet.name=" +   QuarterlyCompliances_Form5_NPAPortletKeys.QUARTERLYCOMPLIANCES_FORM5_NPA,
		"mvc.command.name=" + QuarterlyCompliances_Form5_NPAPortletKeys.saveQuarterlyFormfivenpa,
		}, 
service = MVCResourceCommand.class)

public class QuarterlyCompliances_Form5_NPAMVCResource implements MVCResourceCommand{
	private static Log _log = LogFactoryUtil.getLog(QuarterlyCompliances_Form5_NPAMVCResource.class);
	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws PortletException {
		_log.info("mvcresources::::::::::::form5npa:::::::::::");
_log.info("Inside serve Resource method");
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		JSONArray qformfivenpaJsonArray = JSONFactoryUtil.createJSONArray();
		List<Quaeterlyfromfivenpa> qformfivenpaList = new ArrayList<Quaeterlyfromfivenpa>();
		...
		customerIdcell.setCellValue("S.No.");
				...
				while (rows.hasNext()) {
					...
					qformnpa.setCreatedby(userId);
							...
							if (isError && rowCount > 5) {
								...
								qformfivenpaJsonArray.put(formoneJsonObject);
								qformfivenpaList.add(qformnpa);
							}
							rowCount++;
						}
					}
		...
		_log.info(qformfivenpaJsonArray.toString());
			_log.info(qformfivenpaJsonArray.toString());
			
			if (!isexcelhaserror) {
				QuaeterlyfromfivenpaLocalServiceUtil.addQuarterlyformfivenpa(qformfivenpaList);
