<%@page import="QuarterlyCompliances_Form5_NPA.constants.QuarterlyCompliances_Form5_NPAPortletKeys"%>
<%@ include file="/init.jsp" %>

<!-- <portlet:resourceURL id="/annexureiva/save" var="annexureivaURL"></portlet:resourceURL> -->
<portlet:resourceURL id="<%=QuarterlyCompliances_Form5_NPAPortletKeys.saveQuarterlyFormfivenpa%>" var="saveQuarterlyFormfiveNPAURL" /> 
<!-- 1. -->
<!-- Modal -->
	...
	<div class="row">
	    <div class="col">
	        <div class="page_title">
	            <img src="/o/Liferay-NPS-Theme/images/file-upload.png" alt="Upload Reports" /> Quarterly Compliances under PFRDA Regulations - Form5_NPA
	        </div>
	    </div>
	</div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	...
	    	else if($('input[name="quarterlycompform"]').get(0).files[0].name != "Quarterly Compliances under PFRDA Regulations - As on Sep 30, 2021.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-quarterlycompform").html("Please upload Quarterly Compliances under PFRDA Regulations - As on Sep 30, 2021.xlsx");
	    	    return false;
	    	}
