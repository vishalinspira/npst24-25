...
@Component(property = { "javax.portlet.name=" + An4WeeklyAvgBalReportPortletKeys.AN4WEEKLYAVGBALREPORT,
"mvc.command.name=/rejectionreturn/getreportlogdetails" }, service = MVCResourceCommand.class)
