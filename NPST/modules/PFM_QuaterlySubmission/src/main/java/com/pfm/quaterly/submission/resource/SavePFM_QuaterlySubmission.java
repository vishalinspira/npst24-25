package com.pfm.quaterly.submission.resource;
...
import com.pfm.quaterly.submission.constants.PFM_QuaterlySubmissionPortletKeys;
...
@Component(
		immediate = true,
		property = {
				"javax.portlet.name="+ PFM_QuaterlySubmissionPortletKeys.PFM_QUATERLYSUBMISSION ,
...
public class SavePFM_QuaterlySubmission implements MVCResourceCommand{
	@Override
