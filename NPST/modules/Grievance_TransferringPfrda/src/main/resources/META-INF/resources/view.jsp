...
<portlet:resourceURL id="/savepmra/data" var="PFMMRAFileURl"></portlet:resourceURL>
    ...
    <div class="row">
        <div class="col-12">
           <div class="text-right">
                <p  class="back_btn"><a class="backbtn" href="/web/guest/grievancesam#sddGrievances"><i class="fas fa-arrow-left text-white pr-3"></i>Back</a></p>
           </div>
       </div>
     </div>
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <h4>Transferring of grievances at PFRDA</h4>
                    <div class="content">
					...
					<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
                        ...
                        <div class="nps-input-box file-upload file-upload_ii">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_i" name="unaditedfinancial_i" accept=".xlsx"/>                               
                            </div>
                        ...
                        <div class="nps-input-box file-upload file-upload_iv">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_iii" name="unaditedfinancial_iii" accept=".xlsx"/>                               
                            </div>
                            <label id="error-unaditedfinancial_iii" class="error-message text-danger"></label>
                        </div>
                        <div class="nps-input-box file-upload file-upload_v">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_iv" name="unaditedfinancial_iv" accept=".xlsx"/>                               
                            </div>
                            <label id="error-unaditedfinancial_iv" class="error-message text-danger"></label>
                        </div>
                        <div class="nps-input-box file-upload file-upload_vi">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_v" name="unaditedfinancial_v" accept=".xlsx"/>                               
                            </div>
                            <label id="error-unaditedfinancial_v" class="error-message text-danger"></label>
                        </div>
                        <div class="nps-input-box file-upload file-upload_vii">
                            ...
                            <div class="file-select">
                               ...
                               <input type="file" class="chooseFile" id="chooseFile_vi" name="unaditedfinancial_vi" accept=".xlsx"/>                               
                            </div>
                            <label id="error-unaditedfinancial_vi" class="error-message text-danger"></label>
                        </div>
...
$(document).ready(function() {
	...
	$('#chooseFile_i').bind('change', function () {
		  ...
		  if (/^\s*$/.test(filename)) {
		     ...
		     $(".file-upload_ii").addClass('active');
	...
	$('#chooseFile_ii').bind('change', function () {
		  ...
		  if (/^\s*$/.test(filename)) {
		     ...
		     $(".file-upload_iii").addClass('active');
	...
	$('#chooseFile_iii').bind('change', function () {
		  ...
		  if (/^\s*$/.test(filename)) {
		     ...
		     $(".file-upload_iv").addClass('active');
	...
	$('#chooseFile_v').bind('change', function () {
		  ...
		  if (/^\s*$/.test(filename)) {
		     ...
		     $(".file-upload_vi").addClass('active');
	...
	$('#chooseFile_vi').bind('change', function () {
		  ...
		  if (/^\s*$/.test(filename)) {
		     $(".file-upload_vii").removeClass('active');
...
$(function(){
    $('#upload').on('click', function(){
        ...
        $("#error-unaditedfinancial_iii").html("");
        $("#error-unaditedfinancial_iv").html("");
        $("#error-unaditedfinancial_v").html("");
        $("#error-unaditedfinancial_vi").html("");
        $.ajax({
        	type: "POST",
            processData: false,
            contentType: false,
