...
public class MasterAdminScheduler extends BaseMessageListener {

	private static final Log LOG = LogFactoryUtil.getLog(MasterAdminScheduler.class);
	
	private static final String DEFAULT_CRON_EXPRESSION = "0 0 18 * * ?";
	...
	public void createNewReportLogs() {
