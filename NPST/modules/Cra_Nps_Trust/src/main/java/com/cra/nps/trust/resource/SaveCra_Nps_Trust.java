package com.cra.nps.trust.resource;
...
public class SaveCra_Nps_Trust implements MVCResourceCommand{
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("cranpstrustFile");
		
		_log.info("fileName::::::::::::::::::::::"+fileName);

		File file = uploadPortletRequest.getFile("cranpstrustFile");

		String mimeType = uploadPortletRequest.getContentType("cranpstrustFile");
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName =date.getTime()+ uploadPortletRequest.getFileName("cranpstrustFile");
		...
		String description = "cranpstrustFile";
