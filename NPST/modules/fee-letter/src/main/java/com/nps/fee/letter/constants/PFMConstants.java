package com.nps.fee.letter.constants;
...
public class PFMConstants {
	...
	public static final String HDFC_ADDRESS="HDFC PENSION MANAGEMENT COMPANY LIMITED";
	...
	public static final String LIC_NAME="Shri. Raghupal Singh";
