...
<%@page import="com.nps.fee.letter.constants.PFMConstants"%>
...
<%-- 										<%for(String pfmType:pfmTypes){%>
	                        ...
	                        <div class="nps-input-box col-4 ">
	                            ...
	                            <div class="nps-input-box col-4">
	                            <label style="color:black; " for="month">Month</label>
	                             <input style="color:black; background-color: #E9F3FA;" type="text" class="month" id="month" name="<portlet:namespace/>month"  />  
	                           <label id="error-month" class="error-message text-danger"></label>
	                            </div>
