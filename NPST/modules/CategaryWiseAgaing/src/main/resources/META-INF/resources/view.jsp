...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<portlet:resourceURL id="/categarywie/save" var="savecategarywieURL"></portlet:resourceURL>
	...
	<div class="row">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                <div class="nps-report">
                    <div class="content">
                       <h4>Category wise ageing analysis of grievances at NPST</h4>
						...
						<input type="hidden" value="${reportMasterId }" name="<portlet:namespace/>reportMasterId" class="reportMasterId"/>
	                        ...
	                        <div class="nps-input-box file-upload">
	                            ...
	                            <div class="file-select">
	                               ...
	                               <input type="file" class="chooseFile" id="chooseFile" name="categarywieFile" />                               
	                            </div>
	                            <label id="error-categarywieFile" class="error-message text-danger"></label>
	                        </div>
		...
		$(function(){
		    $('#upload').on('click', function(){
		    	if ($('input[name="categarywieFile"]').get(0).files.length === 0) {
		    	    console.log("No files selected.");
		    	    $("#error-categarywieFile").html("Please select a file to upload");
		    	    return false;
		    	}else if($('input[name="categarywieFile"]').get(0).files[0].name != "Category wise ageing analysis of grievances at NPST.xlsx"){
		    		console.log("No files selected.");
		    	    $("#error-categarywieFile").html("Please upload Category wise ageing analysis of grievances at NPST.xlsx");
		    	    return false;
		    	}
		            ...
		            success:function(data){
		            	...
		            	if(data.status){
		            		//var pdfURL = data.pdfURL;
		           		 	...
		           		 	$(".formrow").show();
		           		 	$('input[name="categarywieFile"').val("");
