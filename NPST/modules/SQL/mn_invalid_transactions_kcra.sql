DROP TABLE IF EXISTS "mn_invalid_transactions_kcra";
DROP SEQUENCE IF EXISTS mn_invalid_transactions_kcra_id__seq1;
CREATE SEQUENCE mn_invalid_transactions_kcra_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.mn_invalid_transactions_kcra (
    id_ bigint NOT NULL,
    sr_no int ,
    ...
    CONSTRAINT mn_invalid_transactions_kcra_pkey PRIMARY KEY (id_)
)WITH (oids = false);