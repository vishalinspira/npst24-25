...
DROP SEQUENCE IF EXISTS apy_id__seq1;
CREATE SEQUENCE apy_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.apy (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT apy_pkey PRIMARY KEY (id_)
) WITH (oids = false);