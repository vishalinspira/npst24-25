DROP TABLE IF EXISTS "all_chq_accepted";
DROP SEQUENCE IF EXISTS all_chq_accepted_id__seq1;
CREATE SEQUENCE all_chq_accepted_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.all_chq_accepted (
    id_ bigint NOT NULL,
    ...
    createdon date,
    createdby bigint,
    CONSTRAINT all_chq_accepted_pkey PRIMARY KEY (id_)
) WITH (oids = false);