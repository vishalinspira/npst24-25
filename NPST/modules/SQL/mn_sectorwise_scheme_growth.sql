DROP TABLE IF EXISTS "mn_sectorwise_scheme_growth";
	DROP SEQUENCE IF EXISTS mn_sectorwise_scheme_growth_id__seq;
	CREATE SEQUENCE mn_sectorwise_scheme_growth_id__seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

	CREATE TABLE "public"."mn_sectorwise_scheme_growth" (
		"id_" integer DEFAULT nextval('mn_sectorwise_scheme_growth_id__seq') NOT NULL,
