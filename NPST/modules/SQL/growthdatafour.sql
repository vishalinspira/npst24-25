DROP TABLE IF EXISTS "growthdatafour";
	DROP SEQUENCE IF EXISTS growthdatafour_id__seq;
	CREATE SEQUENCE growthdatafour_id__seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

	CREATE TABLE "public"."growthdatafour" (
		"id_" integer DEFAULT nextval('growthdatafour_id__seq') NOT NULL,
