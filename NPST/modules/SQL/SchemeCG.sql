...
DROP SEQUENCE IF EXISTS cg_id__seq1;
CREATE SEQUENCE cg_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.cg (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT cg_pkey PRIMARY KEY (id_)
) WITH (oids = false);