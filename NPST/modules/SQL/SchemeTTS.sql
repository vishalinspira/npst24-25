...
DROP SEQUENCE IF EXISTS tts_id__seq1;
CREATE SEQUENCE tts_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE TABLE public.tts (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT tts_pkey PRIMARY KEY (id_)
) WITH (oids = false);