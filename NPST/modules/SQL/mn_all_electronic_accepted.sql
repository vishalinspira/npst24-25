DROP TABLE IF EXISTS "mn_all_electronic_accepted";
DROP SEQUENCE IF EXISTS mn_all_electronic_accepted_id__seq1;
CREATE SEQUENCE mn_all_electronic_accepted_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.mn_all_electronic_accepted (
    id_ bigint NOT NULL,
    ...
    CONSTRAINT mn_all_electronic_accepted_pkey PRIMARY KEY (id_)
) WITH (oids = false);