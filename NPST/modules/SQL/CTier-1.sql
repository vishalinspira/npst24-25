DROP TABLE IF EXISTS "ctier_1";
DROP SEQUENCE IF EXISTS ctier_1_id__seq1;
CREATE SEQUENCE ctier_1_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.ctier_1 (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT ctier_1_pkey PRIMARY KEY (id_)
) WITH (oids = false);