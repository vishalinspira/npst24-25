DROP TABLE IF EXISTS "mn_pfm_aum_growth";
	DROP SEQUENCE IF EXISTS mn_pfm_aum_growth_id__seq;
	CREATE SEQUENCE mn_pfm_aum_growth_id__seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

	CREATE TABLE "public"."mn_pfm_aum_growth" (
		"id_" integer DEFAULT nextval('mn_pfm_aum_growth_id__seq') NOT NULL,
