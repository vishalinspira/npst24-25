DROP TABLE IF EXISTS "gtier_1";
DROP SEQUENCE IF EXISTS gtier_1_id__seq1;
CREATE SEQUENCE gtier_1_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.gtier_1 (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT gtier_1_pkey PRIMARY KEY (id_)
) WITH (oids = false);