DROP TABLE IF EXISTS "mn_cust_tds_nonsalary";
DROP SEQUENCE IF EXISTS mn_cust_tds_nonsalary_id__seq1;
CREATE SEQUENCE mn_cust_tds_nonsalary_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.mn_cust_tds_nonsalary (
    id_ bigint NOT NULL,
	...
	deductee_code_414 character varying,
	...
	deductee_flat_no character varying,
    ...
    createdby bigint,
  CONSTRAINT mn_cust_tds_nonsalary_id_ PRIMARY KEY (id_)
) WITH (oids = false);
