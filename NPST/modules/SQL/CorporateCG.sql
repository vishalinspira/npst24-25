DROP TABLE IF EXISTS "corporatecg";
DROP SEQUENCE IF EXISTS corporatecg_id__seq1;
CREATE SEQUENCE corporatecg_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.corporatecg (
    id_ integer NOT NULL,
    pensionfund character varying,
    ...
    createdon date,
    createdby integer,
    CONSTRAINT corporatecg_pkey PRIMARY KEY (id_)
) WITH (oids = false);