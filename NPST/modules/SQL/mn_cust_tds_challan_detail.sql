DROP TABLE IF EXISTS "mn_cust_tds_challan_detail";
DROP SEQUENCE IF EXISTS mn_cust_tds_challan_detail_id__seq1;
CREATE SEQUENCE mn_cust_tds_challan_detail_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.mn_cust_tds_challan_detail (
    id_ bigint NOT NULL,
    ...
    createdon date,
    createdby bigint,
  CONSTRAINT mn_cust_tds_challan_detail_id_ PRIMARY KEY (id_)
) WITH (oids = false);
