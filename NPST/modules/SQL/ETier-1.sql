DROP TABLE IF EXISTS "etier_1";
DROP SEQUENCE IF EXISTS etier_1_id__seq1;
CREATE SEQUENCE etier_1_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.etier_1 (
    ...
    createdon date,
    createdby integer,
     CONSTRAINT etier_1_pkey PRIMARY KEY (id_)
) WITH (oids = false);