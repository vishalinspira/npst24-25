DROP TABLE IF EXISTS "gtier_2";
DROP SEQUENCE IF EXISTS gtier_2_id__seq1;
CREATE SEQUENCE gtier_2_id__seq1 INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE public.gtier_2 (
    ...
    createdon date,
    createdby integer,
    CONSTRAINT gtier_2_pkey PRIMARY KEY (id_)
) WITH (oids = false);