package com.am_annexure_9.resource;
...
@Component(property = { "javax.portlet.name=" + Am_Annexure_9PortletKeys.AM_ANNEXURE_9,
"mvc.command.name=/annenine_am/save" }, service = MVCResourceCommand.class)

public class SaveAm_Annexure_9 implements MVCResourceCommand {
	@Override
	...
	public JSONObject fileUpload(ThemeDisplay themeDisplay, ResourceRequest resourceRequest) {
		...
		String fileName = uploadPortletRequest.getFileName("annenine_amFile");
		
		_log.info("fileName:::::::::::::::::::::::::::::::::::"+fileName);

		//File file = uploadPortletRequest.getFile("annenine_amFile");
		//String mimeType = uploadPortletRequest.getContentType("annenine_amFile");
		//String title = fileName;
		
		JSONObject resultJsonObject = JSONFactoryUtil.createJSONObject();
	
			Long fileEntryId = 0l;
			long fileEntryIdDoc=0l;
			fileEntryId = uploadFILETOFOLDER(themeDisplay, resourceRequest,"annenine_amFile");
			fileEntryIdDoc = uploadFILETOFOLDER(themeDisplay, resourceRequest,"annenine_amFileDoc");
			try {
				...
				jsonObject.put("Name", "Performance Report & Deviation");
				jsonObject.put("fileEntryId", fileEntryIdDoc);
	...
	public long uploadFILETOFOLDER(ThemeDisplay themeDisplay, ResourceRequest resourceRequest,String docName) {
		...
		//String fileName =date.getTime()+ uploadPortletRequest.getFileName("annenine_amFile");
