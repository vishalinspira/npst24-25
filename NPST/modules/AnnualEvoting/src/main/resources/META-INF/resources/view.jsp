<%@page import="com.annualevoting.constants.AnnualEvotingPortletKeys"%>
<%@ include file="/init.jsp" %>

<portlet:resourceURL id="<%=AnnualEvotingPortletKeys.anEVote%>" var="eVoteResourceURL" /> 
                     ...
                     <aui:form id="fileinfo" method="POST" >
                        ...
                        <div class="nps-input-box file-upload">
                           ...
                           <div class="file-select">
                              ...
                              <input type="file" id="chooseFile" name="annualEVotingFile" />
                           </div>
                           <label id="error-annualEVotingFile" class="error-message text-danger"></label>
                        </div>
  ...
  $(document).ready(function() {
	...
	$(function(){
	    $('#upload').on('click', function(){
	    	if ($('input[name="annualEVotingFile"]').get(0).files.length === 0) {
	    	    console.log("No files selected.");
	    	    $("#error-annualEVotingFile").html("Please select a file to upload");
	    	    return false;
	    	}
	    	else if($('input[name="annualEVotingFile"]').get(0).files[0].name != "Annual Evoting Count.xlsx"){
	    		console.log("No files selected.");
	    		$("#error-annualEVotingFile").html("Please upload Annual Evoting Count.xlsx");
	    	    return false;
	    	}
	        ...
	        $.ajax({
	            ...
	            success:function(data){
	            	...
	            	if(data.status){
	           		 	...
	           		 	$(".formrow").show();
	           		 	$('input[name="annualEVotingFile"').val("");
		           		/* setTimeout(function() {
